...
template<const Level kLevel = Level::kLow, const Speed kSpeed = Speed::kMedium, const Mode kMode = Mode::kOutput>
...
/// A default configuration to map TIM1 CH1 on PA8 pin (output)
using TIM1_CH1_PA8_OUT_CFG2 = TIM1_CH1_PA8_P<Mode::kAlternate, Speed::kMedium>;
/// A default configuration to map TIM1 CH1 on PA8 pin (input)
...
/// A default configuration to map TIM1 CH2 on PA9 pin (output)
using TIM1_CH2_PA9_OUT_CFG2 = TIM1_CH2_PA9_P<Mode::kAlternate, Speed::kMedium>;
/// A default configuration to map TIM1 CH2 on PA9 pin (input)
...
/// A default configuration to map TIM1 CH3 on PA10 pin (output)
using TIM1_CH3_PA10_OUT_CFG2 = TIM1_CH3_PA10_P<Mode::kAlternate, Speed::kMedium>;
/// A default configuration to map TIM1 CH3 on PA10 pin (input)
...
/// A default configuration to map TIM1 CH4 on PA11 pin (output)
using TIM1_CH4_PA11_OUT_CFG2 = TIM1_CH4_PA11_P<Mode::kAlternate, Speed::kMedium>;
/// A default configuration to map TIM1 CH4 on PA11 pin (input)
...
using TIM1_CH1N_PA7_OUT_CFG2 = TIM1_CH1N_PA7_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM1_CH2N_PB0_OUT_CFG2 = TIM1_CH2N_PB0_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM1_CH3N_PB1_OUT_CFG2 = TIM1_CH3N_PB1_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM1_CH1_PE9_OUT_CFG3 = TIM1_CH1_PE9<Mode::kAlternate, Speed::kMedium>;
...
using TIM1_CH2_PE11_OUT_CFG3 = TIM1_CH2_PE11<Mode::kAlternate, Speed::kMedium>;
...
using TIM1_CH3_PE13_OUT_CFG3 = TIM1_CH3_PE13<Mode::kAlternate, Speed::kMedium>;
...
using TIM1_CH4_PE14_OUT_CFG3 = TIM1_CH4_PE14<Mode::kAlternate, Speed::kMedium>;
...
using TIM1_CH1N_PE8_OUT_CFG3 = TIM1_CH1N_PE8<Mode::kAlternate, Speed::kMedium>;
...
using TIM1_CH2N_PE10_OUT_CFG3 = TIM1_CH2N_PE10<Mode::kAlternate, Speed::kMedium>;
...
using TIM1_CH3N_PE12_OUT_CFG3 = TIM1_CH3N_PE12<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH1_PA15_OUT_CFG2 = TIM2_CH1_PA15_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH2_PB3_OUT_CFG2 = TIM2_CH2_PB3_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH3_PA2_OUT_CFG2 = TIM2_CH3_PA2_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH4_PA3_OUT_CFG2 = TIM2_CH4_PA3_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH1_PA0_OUT_CFG3 = TIM2_CH1_PA0_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH2_PA1_OUT_CFG3 = TIM2_CH2_PA1_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH3_PB10_OUT_CFG3 = TIM2_CH3_PB10_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH4_PB11_OUT_CFG3 = TIM2_CH4_PB11_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH1_PA15_OUT_CFG4 = TIM2_CH1_PA15<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH2_PB3_OUT_CFG4 = TIM2_CH2_PB3<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH3_PB10_OUT_CFG4 = TIM2_CH3_PB10<Mode::kAlternate, Speed::kMedium>;
...
using TIM2_CH4_PB11_OUT_CFG4 = TIM2_CH4_PB11<Mode::kAlternate, Speed::kMedium>;
...
using TIM3_CH1_PB4_OUT_CFG2 = TIM3_CH1_PB4_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM3_CH2_PB5_OUT_CFG2 = TIM3_CH2_PB5_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM3_CH3_PB0_OUT_CFG2 = TIM3_CH3_PB0_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM3_CH4_PB1_OUT_CFG2 = TIM3_CH4_PB1_P<Mode::kAlternate, Speed::kMedium>;
...
using TIM3_CH1_PC6_OUT_CFG3 = TIM3_CH1_PC6<Mode::kAlternate, Speed::kMedium>;
...
using TIM3_CH2_PC7_OUT_CFG3 = TIM3_CH2_PC7<Mode::kAlternate, Speed::kMedium>;
...
using TIM3_CH3_PC8_OUT_CFG3 = TIM3_CH3_PC8<Mode::kAlternate, Speed::kMedium>;
...
using TIM3_CH4_PC9_OUT_CFG3 = TIM3_CH4_PC9<Mode::kAlternate, Speed::kMedium>;
