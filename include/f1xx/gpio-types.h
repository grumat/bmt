...
using CAN_RX_PA11 = AnyInPu<Port::PA, 11, AfCan_PA11_12>;
...
using CAN_RX_PB8 = AnyInPu<Port::PB, 8, AfCan_PB8_9>;
...
using CAN_RX_PD0 = AnyInPu<Port::PD, 0, AfCan_PD0_1>;
...
using I2C1_SCL_PB6 = AnyAltOutOD<Port::PB, 6, AfI2C1_PB6_7>;
/// A default configuration to map I2C1 SDA on PB7 pin
using I2C1_SDA_PB7 = AnyAltOutOD<Port::PB, 7, AfI2C1_PB6_7>;
// I2C1 - Configuration 2
/// A default configuration to map I2C1 SCL on PB8 pin
using I2C1_SCL_PB8 = AnyAltOutOD<Port::PB, 8, AfI2C1_PB8_9>;
/// A default configuration to map I2C1 SDA on PB9 pin
using I2C1_SDA_PB9 = AnyAltOutOD<Port::PB, 9, AfI2C1_PB8_9>;
...
using I2C2_SCL_PB10 = AnyAltOutOD<Port::PB, 10, AfNoRemap>;
/// A default configuration to map I2C2 SDA on PB11 pin
using I2C2_SDA_PB11 = AnyAltOutOD<Port::PB, 11, AfNoRemap>;
...
using TIM1_CH1_PA8_OUT = TIM1_CH1_PA8<Mode::kAlternate, Speed::kFast>;
...
using TIM1_CH2_PA9_OUT = TIM1_CH2_PA9<Mode::kAlternate, Speed::kFast>;
...
using TIM1_CH3_PA10_OUT = TIM1_CH3_PA10<Mode::kAlternate, Speed::kFast>;
...
using TIM1_CH4_PA11_OUT = TIM1_CH4_PA11<Mode::kAlternate, Speed::kFast>;
...
/// A default configuration to map TIM1 CH1 on PA8 pin (output)
using TIM1_CH1_PA8_OUT_CFG2 = TIM1_CH1_PA8_P<Mode::kAlternate, Speed::kFast>;
/// A default configuration to map TIM1 CH1 on PA8 pin (input)
...
/// A default configuration to map TIM1 CH2 on PA9 pin (output)
using TIM1_CH2_PA9_OUT_CFG2 = TIM1_CH2_PA9_P<Mode::kAlternate, Speed::kFast>;
/// A default configuration to map TIM1 CH2 on PA9 pin (input)
...
/// A default configuration to map TIM1 CH3 on PA10 pin (output)
using TIM1_CH3_PA10_OUT_CFG2 = TIM1_CH3_PA10_P<Mode::kAlternate, Speed::kFast>;
/// A default configuration to map TIM1 CH3 on PA10 pin (input)
...
/// A default configuration to map TIM1 CH4 on PA11 pin (output)
using TIM1_CH4_PA11_OUT_CFG2 = TIM1_CH4_PA11_P<Mode::kAlternate, Speed::kFast>;
/// A default configuration to map TIM1 CH4 on PA11 pin (input)
...
using TIM1_CH1_PE9_OUT_CFG3 = TIM1_CH1_PE9<Mode::kAlternate, Speed::kFast>;
...
using TIM1_CH2_PE11_OUT_CFG3 = TIM1_CH2_PE11<Mode::kAlternate, Speed::kFast>;
...
using TIM1_CH3_PE13_OUT_CFG3 = TIM1_CH3_PE13<Mode::kAlternate, Speed::kFast>;
...
using TIM1_CH4_PE14_OUT_CFG3 = TIM1_CH4_PE14<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH1_PA0_OUT = TIM2_CH1_PA0<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH2_PA1_OUT = TIM2_CH2_PA1<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH3_PA2_OUT = TIM2_CH3_PA2<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH4_PA3_OUT = TIM2_CH4_PA3<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH1_PA15_OUT_CFG2 = TIM2_CH1_PA15_P<Mode::kAlternate, Speed::kFast>;
/// A default configuration to map TIM2 CH1 on PA15 pin (partial remap/config 2 - input)
using TIM2_CH1_PA15_IN_CFG2 = TIM2_CH1_PA15_P<Mode::kInput, Speed::kInput>;
...
using TIM2_CH2_PB3_OUT_CFG2 = TIM2_CH2_PB3_P<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH3_PA2_OUT_CFG2 = TIM2_CH3_PA2_P<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH4_PA3_OUT_CFG2 = TIM2_CH4_PA3_P<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH1_PA0_OUT_CFG3 = TIM2_CH1_PA0_P<Mode::kAlternate, Speed::kFast>;
/// A default configuration to map TIM2 CH1 on PA0 pin (partial remap/config 3 - input)
using TIM2_CH1_PA0_IN_CFG3 = TIM2_CH1_PA0_P<Mode::kInput, Speed::kInput>;
...
using TIM2_CH2_PA1_OUT_CFG3 = TIM2_CH2_PA1_P<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH3_PB10_OUT_CFG3 = TIM2_CH3_PB10_P<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH4_PB11_OUT_CFG3 = TIM2_CH4_PB11_P<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH1_PA15_OUT_CFG4 = TIM2_CH1_PA15<Mode::kAlternate, Speed::kFast>;
/// A default configuration to map TIM2 CH1 on PA15 pin (full remap/config 4 - input)
using TIM2_CH1_PA15_IN_CFG4 = TIM2_CH1_PA15<Mode::kInput, Speed::kInput>;
...
using TIM2_CH2_PB3_OUT_CFG4 = TIM2_CH2_PB3<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH3_PB10_OUT_CFG4 = TIM2_CH3_PB10<Mode::kAlternate, Speed::kFast>;
...
using TIM2_CH4_PB11_OUT_CFG4 = TIM2_CH4_PB11<Mode::kAlternate, Speed::kFast>;
...
using TIM3_CH1_PA6_OUT = TIM3_CH1_PA6<Mode::kAlternate, Speed::kFast>;
...
using TIM3_CH2_PA7_OUT = TIM3_CH2_PA7<Mode::kAlternate, Speed::kFast>;
...
using TIM3_CH3_PB0_OUT = TIM3_CH3_PB0<Mode::kAlternate, Speed::kFast>;
/// A default configuration to map TIM3 CH3 on PB0 pin (input)
...
using TIM3_CH4_PB1_OUT = TIM3_CH4_PB1<Mode::kAlternate, Speed::kFast>;
/// A default configuration to map TIM3 CH4 on PB1 pin (input)
...
using TIM3_CH1_PB4_OUT_CFG2 = TIM3_CH1_PB4_P<Mode::kAlternate, Speed::kFast>;
...
using TIM3_CH2_PB5_OUT_CFG2 = TIM3_CH2_PB5_P<Mode::kAlternate, Speed::kFast>;
...
using TIM3_CH3_PB0_OUT_CFG2 = TIM3_CH3_PB0_P<Mode::kAlternate, Speed::kFast>;
...
using TIM3_CH4_PB1_OUT_CFG2 = TIM3_CH4_PB1_P<Mode::kAlternate, Speed::kFast>;
...
using TIM3_CH1_PC6_OUT_CFG3 = TIM3_CH1_PC6<Mode::kAlternate, Speed::kFast>;
...
using TIM3_CH2_PC7_OUT_CFG3 = TIM3_CH2_PC7<Mode::kAlternate, Speed::kFast>;
...
using TIM3_CH3_PC8_OUT_CFG3 = TIM3_CH3_PC8<Mode::kAlternate, Speed::kFast>;
...
using TIM3_CH4_PC9_OUT_CFG3 = TIM3_CH4_PC9<Mode::kAlternate, Speed::kFast>;
...
using TIM4_CH1_PB6_OUT = TIM4_CH1_PB6<Mode::kAlternate, Speed::kFast>;
...
using TIM4_CH2_PB7_OUT = TIM4_CH2_PB7<Mode::kAlternate, Speed::kFast>;
...
using TIM4_CH3_PB8_OUT = TIM4_CH3_PB8<Mode::kAlternate, Speed::kFast>;
...
using TIM4_CH4_PB9_OUT = TIM4_CH4_PB9<Mode::kAlternate, Speed::kFast>;
...
using TIM4_CH1_PD12_OUT = TIM4_CH1_PD12<Mode::kAlternate, Speed::kFast>;
...
using TIM4_CH2_PD13_OUT = TIM4_CH2_PD13<Mode::kAlternate, Speed::kFast>;
...
using TIM4_CH3_PD14_OUT = TIM4_CH3_PD14<Mode::kAlternate, Speed::kFast>;
...
using TIM4_CH4_PD15_OUT = TIM4_CH4_PD15<Mode::kAlternate, Speed::kFast>;
...
using USART1_TX_PA9 = AnyAltOut<Port::PA, 9, AfUsart1_PA9_10>;
...
using USART1_TX_PB6 = AnyAltOut<Port::PB, 6, AfUsart1_PB6_7>;
...
using USART1_CK_PA8 = AnyAltOut<Port::PA, 8, AfNoRemap>;
/// A generic configuration to map USART1 CTS on PA8 pin (config 1 & 2)
using USART1_CTS_PA11 = AnyInPu<Port::PA, 11, AfNoRemap>;
...
using USART2_CTS_PA0 = AnyInPu<Port::PA, 0, AfUsart2_PA0_1_2_3_4>;
/// A generic configuration to map USART2 RTS on PA1 pin (config 1)
using USART2_RTS_PA1 = AnyAltOut<Port::PA, 1, AfUsart2_PA0_1_2_3_4>;
/// A generic configuration to map USART2 TX on PA2 pin (config 1)
using USART2_TX_PA2 = AnyAltOut<Port::PA, 2, AfUsart2_PA0_1_2_3_4>;
/// A generic configuration to map USART2 RX on PA3 pin (config 1)
using USART2_RX_PA3 = AnyInPu<Port::PA, 3, AfUsart2_PA0_1_2_3_4>;
...
using USART2_CTS_PD3 = AnyInPu<Port::PD, 3, AfUsart2_PD3_4_5_6_7>;
/// A generic configuration to map USART2 RTS on PD4 pin (config 2)
using USART2_RTS_PD4 = AnyAltOut<Port::PD, 4, AfUsart2_PD3_4_5_6_7>;
/// A generic configuration to map USART2 TX on PD5 pin (config 2)
using USART2_TX_PD5 = AnyAltOut<Port::PD, 5, AfUsart2_PD3_4_5_6_7>;
/// A generic configuration to map USART2 RX on PD6 pin (config 2)
using USART2_RX_PD6 = AnyInPu<Port::PD, 6, AfUsart2_PD3_4_5_6_7>;
...
using USART3_TX_PB10 = AnyAltOut<Port::PB, 10, AfUsart3_PB10_11_12_13_14>;
/// A generic configuration to map USART3 RX on PB11 pin (config 2)
using USART3_RX_PB11 = AnyInPu<Port::PB, 11, AfUsart3_PB10_11_12_13_14>;
...
using USART3_CTS_PB13 = AnyInPu<Port::PB, 13, AfUsart3_PB10_11_12_13_14>;
...
//////////////////////////////////////////////////////////////////////
using USART3_TX_PC10 = AnyAltOut<Port::PC, 10, AfUsart3_PC10_11_12_PB13_14>;
using USART3_RX_PC11 = AnyInPu<Port::PC, 11, AfUsart3_PC10_11_12_PB13_14>;
using USART3_CK_PC12 = AnyAltOut<Port::PC, 12, AfUsart3_PC10_11_12_PB13_14>;

//////////////////////////////////////////////////////////////////////
// USART3 - Configuration 3
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map USART3 TX on PD8 pin (config 3)
using USART3_TX_PD8 = AnyAltOut<Port::PD, 8, AfUsart3_PD8_9_10_11_12>;
/// A generic configuration to map USART3 RX on PD9 pin (config 3)
using USART3_RX_PD9 = AnyInPu<Port::PD, 9, AfUsart3_PD8_9_10_11_12>;
/// A generic configuration to map USART3 CK on PD10 pin (config 3)
using USART3_CK_PD10 = AnyAltOut<Port::PD, 10, AfUsart3_PD8_9_10_11_12>;
/// A generic configuration to map USART3 CTS on PD11 pin (config 3)
using USART3_CTS_PD11 = AnyInPu<Port::PD, 11, AfUsart3_PD8_9_10_11_12>;
...
using USB_DM_PA11 = Floating<Port::PA, 11, AfNoRemap>;
...
using TAMPER_RTC_PC13 = AnyAltOutPP<Port::PC, 13, AfNoRemap>;
/// A generic configuration to map OSC32_IN on PC14 pin
using OSC32_IN_PC14 = Floating<Port::PC, 14, AfNoRemap>;
...
using JTMS_FULL_PA13 = Floating<Port::PA, 13, AfJtag5>;
/// A generic configuration to map JTMS on PA14 pin (full JTAG port)
using JTCK_FULL_PA14 = Floating<Port::PA, 14, AfJtag5>;
/// A generic configuration to map JTMS on PA15 pin (full JTAG port)
using JTDI_FULL_PA15 = Floating<Port::PA, 15, AfJtag5>;
/// A generic configuration to map JTMS on PB3 pin (full JTAG port)
using JTDO_FULL_PB3 = Floating<Port::PB, 3, AfJtag5>;
...
using JTMS_PA13 = Floating<Port::PA, 13, AfJtag4>;
/// A generic configuration to map JTCK on PA14 pin (4-pin JTAG port)
using JTCK_PA14 = Floating<Port::PA, 14, AfJtag4>;
/// A generic configuration to map JTCK on PA15 pin (4-pin JTAG port)
using JTDI_PA15 = Floating<Port::PA, 15, AfJtag4>;
/// A generic configuration to map JTCK on PA15 pin (4-pin JTAG port)
...
using SWDIO_FULL_PA13 = Floating<Port::PA, 13, AfSwd3>;
/// A generic configuration to map SWCLK on PA14 pin (full SWD port)
using SWCLK_FULL_PA14 = Floating<Port::PA, 14, AfSwd3>;
...
//////////////////////////////////////////////////////////////////////
/// A generic configuration to map SWDIO on PA13 pin (full SWD port)
using SWDIO_PA13 = Floating<Port::PA, 13, AfSwd2>;
/// A generic configuration to map SWCLK on PA14 pin (full SWD port)
