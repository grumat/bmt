...
using AfI2C1_PB6_7 = AnyAFR<0x00000000U, ~AFIO_MAPR_I2C1_REMAP_Msk>;
...
using AfUsart2_PA0_1_2_3_4 = AnyAFR<0x00000000U, ~AFIO_MAPR_USART2_REMAP_Msk>;
...
using AfUsart3_PB10_11_12_13_14 = AnyAFR<AFIO_MAPR_USART3_REMAP_NOREMAP, ~AFIO_MAPR_USART3_REMAP_Msk>;
/// USART3 alternate configuration 2 using PC10, PC11, PC12, PC13 and PC14
using AfUsart3_PC10_11_12_PB13_14 = AnyAFR<AFIO_MAPR_USART3_REMAP_PARTIALREMAP, ~AFIO_MAPR_USART3_REMAP_Msk>;
...
using AfTim1_PA12_8_9_10_11_PB12_13_14_15 = AnyAFR<AFIO_MAPR_TIM1_REMAP_NOREMAP, ~AFIO_MAPR_TIM1_REMAP_Msk>;
/// TIM1 alternate configuration 2 using PA12, PA8-11, PA6-7 and PB0-1
using AfTim1_PA12_8_9_10_11_6_7_PB0_1 = AnyAFR<AFIO_MAPR_TIM1_REMAP_PARTIALREMAP, ~AFIO_MAPR_TIM1_REMAP_Msk>;
...
using AfTim2_PA0_1_2_3 = AnyAFR<AFIO_MAPR_TIM2_REMAP_NOREMAP, ~AFIO_MAPR_TIM2_REMAP_Msk>;
/// TIM2 alternate configuration 2 using PA15, PB3, and PA2-3
using AfTim2_PA15_PB3_PA2_3 = AnyAFR<AFIO_MAPR_TIM2_REMAP_PARTIALREMAP1, ~AFIO_MAPR_TIM2_REMAP_Msk>;
/// TIM2 alternate configuration 3 using PA0-1 and PB10-11
using AfTim2_PA0_1_PB10_11 = AnyAFR<AFIO_MAPR_TIM2_REMAP_PARTIALREMAP2, ~AFIO_MAPR_TIM2_REMAP_Msk>;
...
using AfTim3_PA6_7_PB0_1 = AnyAFR<AFIO_MAPR_TIM3_REMAP_NOREMAP, ~AFIO_MAPR_TIM3_REMAP_Msk>;
/// TIM3 alternate configuration 2 using PB4-5 and PB0-1
using AfTim3_PB4_5_0_1 = AnyAFR<AFIO_MAPR_TIM3_REMAP_PARTIALREMAP, ~AFIO_MAPR_TIM3_REMAP_Msk>;
...
using AfTim4_PB6_7_8_9 = AnyAFR<0x00000000U, ~AFIO_MAPR_TIM4_REMAP_Msk>;
...
using AfCan_PA11_12 = AnyAFR<AFIO_MAPR_CAN_REMAP_REMAP1, ~AFIO_MAPR_CAN_REMAP_Msk>;
/// CAN alternate configuration 2 using PB8-9
using AfCan_PB8_9 = AnyAFR<AFIO_MAPR_CAN_REMAP_REMAP2, ~AFIO_MAPR_CAN_REMAP_Msk>;
...
using Af_PD01_OSC = AnyAFR<0x00000000U, ~AFIO_MAPR_PD01_REMAP_Msk>;
...
using AfJtag5 = AnyAFR<AFIO_MAPR_SWJ_CFG_RESET, ~AFIO_MAPR_SWJ_CFG_Msk>;
/// 4-pin JTAG bus active
using AfJtag4 = AnyAFR<AFIO_MAPR_SWJ_CFG_NOJNTRST, ~AFIO_MAPR_SWJ_CFG_Msk>;
