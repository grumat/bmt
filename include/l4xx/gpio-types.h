...
using NJTRST_PB4 = AnyAltOut<Port::PB, 4, AfNJTRST_PB4, Speed::kSlow, Level::kLow, PuPd::kPullUp>	;
/// A default configuration to map TRACED0 on PC1 pin
using TRACED0_PC1 = AnyAltOut<Port::PC, 1, AfTRACED0_PC1, Speed::kFast>	;
/// A default configuration to map TRACED1 on PC10 pin
using TRACED1_PC10 = AnyAltOut<Port::PC, 10, AfTRACED1_PC10, Speed::kFast>	;
/// A default configuration to map TRACED3 on PC12 pin
using TRACED3_PC12 = AnyAltOut<Port::PC, 12, AfTRACED3_PC12, Speed::kFast>	;
...
using TRACED2_PD2 = AnyAltOut<Port::PD, 2, AfTRACED2_PD2, Speed::kFast>	;
#endif	// defined(GPIOD_BASE)
#if defined(GPIOE_BASE)
/// A default configuration to map TRACECLK on PE2 pin
using TRACECLK_PE2 = AnyAltOut<Port::PE, 2, AfTRACECLK_PE2, Speed::kFast>	;
...
using CAN1_TX_PH13 = AnyAltOut<Port::PH, 13, AfCAN1_TX_PH13>	;
#endif	// defined(GPIOH_BASE)
#if defined(GPIOI_BASE)
/// A default configuration to map CAN1 RX on PI9 pin
using CAN1_RX_PI9 = AnyAltOut<Port::PI, 9, AfCAN1_RX_PI9>	;
...
using COMP1_OUT_PB0 = AnyAltOut<Port::PB, 0, AfCOMP1_OUT_PB0>	;
/// A default configuration to map COMP1 OUT on PB10 pin
using COMP1_OUT_PB10 = AnyAltOut<Port::PB, 10, AfCOMP1_OUT_PB10>	;
...
using Analog_PB3 = AnyAnalog<Port::PB, 3>	;
/// A default configuration to map COMP2 INM on PB7 pin
using Analog_PB7 = AnyAnalog<Port::PB, 7>	;
/// A default configuration to map COMP2 INP on PB4 pin
using Analog_PB4 = AnyAnalog<Port::PB, 4>	;
/// A default configuration to map COMP2 INP on PB6 pin
using Analog_PB6 = AnyAnalog<Port::PB, 6>	;
/// A default configuration to map COMP2 OUT on PB5 pin
using COMP2_OUT_PB5 = AnyAltOut<Port::PB, 5, AfCOMP2_OUT_PB5>	;
/// A default configuration to map COMP2 OUT on PB11 pin
using COMP2_OUT_PB11 = AnyAltOut<Port::PB, 11, AfCOMP2_OUT_PB11>	;
...
using DFSDM1_CKIN0_PB2 = AnyAltOut<Port::PB, 2, AfDFSDM1_CKIN0_PB2>	;
/// A default configuration to map DFSDM1 CKIN1 on PB13 pin
using DFSDM1_CKIN1_PB13 = AnyAltOut<Port::PB, 13, AfDFSDM1_CKIN1_PB13>	;
/// A default configuration to map DFSDM1 CKIN2 on PB15 pin
using DFSDM1_CKIN2_PB15 = AnyAltOut<Port::PB, 15, AfDFSDM1_CKIN2_PB15>	;
/// A default configuration to map DFSDM1 CKIN3 on PC6 pin
using DFSDM1_CKIN3_PC6 = AnyAltOut<Port::PC, 6, AfDFSDM1_CKIN3_PC6>	;
/// A default configuration to map DFSDM1 CKIN4 on PC1 pin
using DFSDM1_CKIN4_PC1 = AnyAltOut<Port::PC, 1, AfDFSDM1_CKIN4_PC1>	;
/// A default configuration to map DFSDM1 CKIN5 on PB7 pin
using DFSDM1_CKIN5_PB7 = AnyAltOut<Port::PB, 7, AfDFSDM1_CKIN5_PB7>	;
/// A default configuration to map DFSDM1 CKIN6 on PB9 pin
using DFSDM1_CKIN6_PB9 = AnyAltOut<Port::PB, 9, AfDFSDM1_CKIN6_PB9>	;
/// A default configuration to map DFSDM1 CKIN7 on PB11 pin
using DFSDM1_CKIN7_PB11 = AnyAltOut<Port::PB, 11, AfDFSDM1_CKIN7_PB11>	;
/// A default configuration to map DFSDM1 CKOUT on PC2 pin
using DFSDM1_CKOUT_PC2 = AnyAltOut<Port::PC, 2, AfDFSDM1_CKOUT_PC2>	;
/// A default configuration to map DFSDM1 DATIN0 on PB1 pin
using DFSDM1_DATIN0_PB1 = AnyAltOut<Port::PB, 1, AfDFSDM1_DATIN0_PB1>	;
/// A default configuration to map DFSDM1 DATIN1 on PB12 pin
using DFSDM1_DATIN1_PB12 = AnyAltOut<Port::PB, 12, AfDFSDM1_DATIN1_PB12>	;
/// A default configuration to map DFSDM1 DATIN2 on PB14 pin
using DFSDM1_DATIN2_PB14 = AnyAltOut<Port::PB, 14, AfDFSDM1_DATIN2_PB14>	;
/// A default configuration to map DFSDM1 DATIN3 on PC7 pin
using DFSDM1_DATIN3_PC7 = AnyAltOut<Port::PC, 7, AfDFSDM1_DATIN3_PC7>	;
/// A default configuration to map DFSDM1 DATIN4 on PC0 pin
using DFSDM1_DATIN4_PC0 = AnyAltOut<Port::PC, 0, AfDFSDM1_DATIN4_PC0>	;
/// A default configuration to map DFSDM1 DATIN5 on PB6 pin
using DFSDM1_DATIN5_PB6 = AnyAltOut<Port::PB, 6, AfDFSDM1_DATIN5_PB6>	;
/// A default configuration to map DFSDM1 DATIN6 on PB8 pin
using DFSDM1_DATIN6_PB8 = AnyAltOut<Port::PB, 8, AfDFSDM1_DATIN6_PB8>	;
/// A default configuration to map DFSDM1 DATIN7 on PB10 pin
using DFSDM1_DATIN7_PB10 = AnyAltOut<Port::PB, 10, AfDFSDM1_DATIN7_PB10>	;
#if defined(GPIOD_BASE)
/// A default configuration to map DFSDM1 CKIN0 on PD4 pin
using DFSDM1_CKIN0_PD4 = AnyAltOut<Port::PD, 4, AfDFSDM1_CKIN0_PD4>	;
/// A default configuration to map DFSDM1 CKIN1 on PD7 pin
using DFSDM1_CKIN1_PD7 = AnyAltOut<Port::PD, 7, AfDFSDM1_CKIN1_PD7>	;
/// A default configuration to map DFSDM1 CKIN7 on PD1 pin
using DFSDM1_CKIN7_PD1 = AnyAltOut<Port::PD, 1, AfDFSDM1_CKIN7_PD1>	;
/// A default configuration to map DFSDM1 DATIN0 on PD3 pin
using DFSDM1_DATIN0_PD3 = AnyAltOut<Port::PD, 3, AfDFSDM1_DATIN0_PD3>	;
/// A default configuration to map DFSDM1 DATIN1 on PD6 pin
using DFSDM1_DATIN1_PD6 = AnyAltOut<Port::PD, 6, AfDFSDM1_DATIN1_PD6>	;
/// A default configuration to map DFSDM1 DATIN7 on PD0 pin
using DFSDM1_DATIN7_PD0 = AnyAltOut<Port::PD, 0, AfDFSDM1_DATIN7_PD0>	;
#endif	// defined(GPIOD_BASE)
#if defined(GPIOE_BASE)
/// A default configuration to map DFSDM1 CKIN2 on PE8 pin
using DFSDM1_CKIN2_PE8 = AnyAltOut<Port::PE, 8, AfDFSDM1_CKIN2_PE8>	;
/// A default configuration to map DFSDM1 CKIN3 on PE5 pin
using DFSDM1_CKIN3_PE5 = AnyAltOut<Port::PE, 5, AfDFSDM1_CKIN3_PE5>	;
/// A default configuration to map DFSDM1 CKIN4 on PE11 pin
using DFSDM1_CKIN4_PE11 = AnyAltOut<Port::PE, 11, AfDFSDM1_CKIN4_PE11>	;
/// A default configuration to map DFSDM1 CKIN5 on PE13 pin
using DFSDM1_CKIN5_PE13 = AnyAltOut<Port::PE, 13, AfDFSDM1_CKIN5_PE13>	;
/// A default configuration to map DFSDM1 CKOUT on PE9 pin
using DFSDM1_CKOUT_PE9 = AnyAltOut<Port::PE, 9, AfDFSDM1_CKOUT_PE9>	;
/// A default configuration to map DFSDM1 DATIN2 on PE7 pin
using DFSDM1_DATIN2_PE7 = AnyAltOut<Port::PE, 7, AfDFSDM1_DATIN2_PE7>	;
/// A default configuration to map DFSDM1 DATIN3 on PE4 pin
using DFSDM1_DATIN3_PE4 = AnyAltOut<Port::PE, 4, AfDFSDM1_DATIN3_PE4>	;
/// A default configuration to map DFSDM1 DATIN4 on PE10 pin
using DFSDM1_DATIN4_PE10 = AnyAltOut<Port::PE, 10, AfDFSDM1_DATIN4_PE10>	;
/// A default configuration to map DFSDM1 DATIN5 on PE12 pin
using DFSDM1_DATIN5_PE12 = AnyAltOut<Port::PE, 12, AfDFSDM1_DATIN5_PE12>	;
#endif	// defined(GPIOE_BASE)
#if defined(GPIOF_BASE)
/// A default configuration to map DFSDM1 CKIN6 on PF14 pin
using DFSDM1_CKIN6_PF14 = AnyAltOut<Port::PF, 14, AfDFSDM1_CKIN6_PF14>	;
/// A default configuration to map DFSDM1 DATIN6 on PF13 pin
using DFSDM1_DATIN6_PF13 = AnyAltOut<Port::PF, 13, AfDFSDM1_DATIN6_PF13>	;
#endif	// defined(GPIOF_BASE)
...
using DCMI_D0_PA9 = AnyAltOut<Port::PA, 9, AfDCMI_D0_PA9>	;
/// A default configuration to map DCMI D0 on PC6 pin
using DCMI_D0_PC6 = AnyAltOut<Port::PC, 6, AfDCMI_D0_PC6>	;
/// A default configuration to map DCMI D1 on PA10 pin
using DCMI_D1_PA10 = AnyAltOut<Port::PA, 10, AfDCMI_D1_PA10>	;
/// A default configuration to map DCMI D1 on PC7 pin
using DCMI_D1_PC7 = AnyAltOut<Port::PC, 7, AfDCMI_D1_PC7>	;
/// A default configuration to map DCMI D10 on PB5 pin
using DCMI_D10_PB5 = AnyAltOut<Port::PB, 5, AfDCMI_D10_PB5>	;
/// A default configuration to map DCMI D12 on PB4 pin
using DCMI_D12_PB4 = AnyAltOut<Port::PB, 4, AfDCMI_D12_PB4>	;
/// A default configuration to map DCMI D2 on PC8 pin
using DCMI_D2_PC8 = AnyAltOut<Port::PC, 8, AfDCMI_D2_PC8>	;
/// A default configuration to map DCMI D3 on PC9 pin
using DCMI_D3_PC9 = AnyAltOut<Port::PC, 9, AfDCMI_D3_PC9>	;
/// A default configuration to map DCMI D4 on PC11 pin
using DCMI_D4_PC11 = AnyAltOut<Port::PC, 11, AfDCMI_D4_PC11>	;
/// A default configuration to map DCMI D5 on PB6 pin
using DCMI_D5_PB6 = AnyAltOut<Port::PB, 6, AfDCMI_D5_PB6>	;
/// A default configuration to map DCMI D6 on PB8 pin
using DCMI_D6_PB8 = AnyAltOut<Port::PB, 8, AfDCMI_D6_PB8>	;
/// A default configuration to map DCMI D7 on PB9 pin
using DCMI_D7_PB9 = AnyAltOut<Port::PB, 9, AfDCMI_D7_PB9>	;
/// A default configuration to map DCMI D8 on PC10 pin
using DCMI_D8_PC10 = AnyAltOut<Port::PC, 10, AfDCMI_D8_PC10>	;
/// A default configuration to map DCMI D9 on PC12 pin
using DCMI_D9_PC12 = AnyAltOut<Port::PC, 12, AfDCMI_D9_PC12>	;
/// A default configuration to map DCMI HSYNC on PA4 pin
using DCMI_HSYNC_PA4 = AnyAltOut<Port::PA, 4, AfDCMI_HSYNC_PA4>	;
/// A default configuration to map DCMI PIXCLK on PA6 pin
using DCMI_PIXCLK_PA6 = AnyAltOut<Port::PA, 6, AfDCMI_PIXCLK_PA6>	;
/// A default configuration to map DCMI VSYNC on PB7 pin
using DCMI_VSYNC_PB7 = AnyAltOut<Port::PB, 7, AfDCMI_VSYNC_PB7>	;
#if defined(GPIOD_BASE)
/// A default configuration to map DCMI D10 on PD6 pin
using DCMI_D10_PD6 = AnyAltOut<Port::PD, 6, AfDCMI_D10_PD6>	;
/// A default configuration to map DCMI D11 on PD2 pin
using DCMI_D11_PD2 = AnyAltOut<Port::PD, 2, AfDCMI_D11_PD2>	;
/// A default configuration to map DCMI D5 on PD3 pin
using DCMI_D5_PD3 = AnyAltOut<Port::PD, 3, AfDCMI_D5_PD3>	;
/// A default configuration to map DCMI HSYNC on PD8 pin
using DCMI_HSYNC_PD8 = AnyAltOut<Port::PD, 8, AfDCMI_HSYNC_PD8>	;
/// A default configuration to map DCMI PIXCLK on PD9 pin
using DCMI_PIXCLK_PD9 = AnyAltOut<Port::PD, 9, AfDCMI_PIXCLK_PD9>	;
#endif	// defined(GPIOD_BASE)
#if defined(GPIOE_BASE)
/// A default configuration to map DCMI D2 on PE0 pin
using DCMI_D2_PE0 = AnyAltOut<Port::PE, 0, AfDCMI_D2_PE0>	;
/// A default configuration to map DCMI D3 on PE1 pin
using DCMI_D3_PE1 = AnyAltOut<Port::PE, 1, AfDCMI_D3_PE1>	;
/// A default configuration to map DCMI D4 on PE4 pin
using DCMI_D4_PE4 = AnyAltOut<Port::PE, 4, AfDCMI_D4_PE4>	;
/// A default configuration to map DCMI D6 on PE5 pin
using DCMI_D6_PE5 = AnyAltOut<Port::PE, 5, AfDCMI_D6_PE5>	;
/// A default configuration to map DCMI D7 on PE6 pin
using DCMI_D7_PE6 = AnyAltOut<Port::PE, 6, AfDCMI_D7_PE6>	;
#endif	// defined(GPIOE_BASE)
#if defined(GPIOF_BASE)
/// A default configuration to map DCMI D11 on PF10 pin
using DCMI_D11_PF10 = AnyAltOut<Port::PF, 10, AfDCMI_D11_PF10>	;
/// A default configuration to map DCMI D12 on PF11 pin
using DCMI_D12_PF11 = AnyAltOut<Port::PF, 11, AfDCMI_D12_PF11>	;
#endif	// defined(GPIOF_BASE)
#if defined(GPIOG_BASE)
/// A default configuration to map DCMI D13 on PG15 pin
using DCMI_D13_PG15 = AnyAltOut<Port::PG, 15, AfDCMI_D13_PG15>	;
#endif	// defined(GPIOG_BASE)
#if defined(GPIOH_BASE)
/// A default configuration to map DCMI D0 on PH9 pin
using DCMI_D0_PH9 = AnyAltOut<Port::PH, 9, AfDCMI_D0_PH9>	;
/// A default configuration to map DCMI D1 on PH10 pin
using DCMI_D1_PH10 = AnyAltOut<Port::PH, 10, AfDCMI_D1_PH10>	;
/// A default configuration to map DCMI D11 on PH15 pin
using DCMI_D11_PH15 = AnyAltOut<Port::PH, 15, AfDCMI_D11_PH15>	;
/// A default configuration to map DCMI D2 on PH11 pin
using DCMI_D2_PH11 = AnyAltOut<Port::PH, 11, AfDCMI_D2_PH11>	;
/// A default configuration to map DCMI D3 on PH12 pin
using DCMI_D3_PH12 = AnyAltOut<Port::PH, 12, AfDCMI_D3_PH12>	;
/// A default configuration to map DCMI D4 on PH14 pin
using DCMI_D4_PH14 = AnyAltOut<Port::PH, 14, AfDCMI_D4_PH14>	;
/// A default configuration to map DCMI D8 on PH6 pin
using DCMI_D8_PH6 = AnyAltOut<Port::PH, 6, AfDCMI_D8_PH6>	;
/// A default configuration to map DCMI D9 on PH7 pin
using DCMI_D9_PH7 = AnyAltOut<Port::PH, 7, AfDCMI_D9_PH7>	;
/// A default configuration to map DCMI HSYNC on PH8 pin
using DCMI_HSYNC_PH8 = AnyAltOut<Port::PH, 8, AfDCMI_HSYNC_PH8>	;
/// A default configuration to map DCMI PIXCLK on PH5 pin
using DCMI_PIXCLK_PH5 = AnyAltOut<Port::PH, 5, AfDCMI_PIXCLK_PH5>	;
#endif	// defined(GPIOH_BASE)
#if defined(GPIOI_BASE)
/// A default configuration to map DCMI D10 on PI3 pin
using DCMI_D10_PI3 = AnyAltOut<Port::PI, 3, AfDCMI_D10_PI3>	;
/// A default configuration to map DCMI D12 on PI8 pin
using DCMI_D12_PI8 = AnyAltOut<Port::PI, 8, AfDCMI_D12_PI8>	;
/// A default configuration to map DCMI D13 on PI0 pin
using DCMI_D13_PI0 = AnyAltOut<Port::PI, 0, AfDCMI_D13_PI0>	;
/// A default configuration to map DCMI D5 on PI4 pin
using DCMI_D5_PI4 = AnyAltOut<Port::PI, 4, AfDCMI_D5_PI4>	;
/// A default configuration to map DCMI D6 on PI6 pin
using DCMI_D6_PI6 = AnyAltOut<Port::PI, 6, AfDCMI_D6_PI6>	;
/// A default configuration to map DCMI D7 on PI7 pin
using DCMI_D7_PI7 = AnyAltOut<Port::PI, 7, AfDCMI_D7_PI7>	;
/// A default configuration to map DCMI D8 on PI1 pin
using DCMI_D8_PI1 = AnyAltOut<Port::PI, 1, AfDCMI_D8_PI1>	;
/// A default configuration to map DCMI D9 on PI2 pin
using DCMI_D9_PI2 = AnyAltOut<Port::PI, 2, AfDCMI_D9_PI2>	;
/// A default configuration to map DCMI VSYNC on PI5 pin
using DCMI_VSYNC_PI5 = AnyAltOut<Port::PI, 5, AfDCMI_VSYNC_PI5>	;
#endif	// defined(GPIOI_BASE)
...
using FMC_A0_PF0 = AnyAltOut<Port::PF, 0, AfFMC_A0_PF0>		;
/// A default configuration to map FMC A1 on PF1 pin
using FMC_A1_PF1 = AnyAltOut<Port::PF, 1, AfFMC_A1_PF1>		;
...
using FMC_A24_PG13 = AnyAltOut<Port::PG, 13, AfFMC_A24_PG13>	;
/// A default configuration to map FMC A25 on PG14 pin
using FMC_A25_PG14 = AnyAltOut<Port::PG, 14, AfFMC_A25_PG14>	;
...
using FMC_NE3_PG10 = AnyAltOut<Port::PG, 10, AfFMC_NE3_PG10>	;
/// A default configuration to map FMC NE4 on PG12 pin
using FMC_NE4_PG12 = AnyAltOut<Port::PG, 12, AfFMC_NE4_PG12>	;
#endif	// defined(GPIOG_BASE)
...
using AfI2C1_SCL_PA9 = AnyAltOutOD<Port::PA, 9, AfI2C1_SCL_PA9>	;
/// A default configuration to map I2C1 SCL on PB6 pin
using AfI2C1_SCL_PB6 = AnyAltOutOD<Port::PB, 6, AfI2C1_SCL_PB6>	;
...
using AfI2C1_SDA_PA10 = AnyAltOutOD<Port::PA, 10, AfI2C1_SDA_PA10>	;
...
using AfI2C1_SMBA_PA1 = AnyAltOutOD<Port::PA, 1, AfI2C1_SMBA_PA1>	;
/// A default configuration to map I2C1 SMBA on PA14 pin
using AfI2C1_SMBA_PA14 = AnyAltOutOD<Port::PA, 14, AfI2C1_SMBA_PA14>	;
...
using AfI2C1_SCL_PG14 = AnyAltOutOD<Port::PG, 14, AfI2C1_SCL_PG14>	;
/// A default configuration to map I2C1 SDA on PG13 pin
using AfI2C1_SDA_PG13 = AnyAltOutOD<Port::PG, 13, AfI2C1_SDA_PG13>	;
/// A default configuration to map I2C1 SMBA on PG15 pin
using AfI2C1_SMBA_PG15 = AnyAltOutOD<Port::PG, 15, AfI2C1_SMBA_PG15>	;
#endif	// defined(GPIOG_BASE)
...
using AfI2C2_SCL_PB10 = AnyAltOutOD<Port::PB, 10, AfI2C2_SCL_PB10>	;
/// A default configuration to map I2C2 SCL on PB13 pin
using AfI2C2_SCL_PB13 = AnyAltOutOD<Port::PB, 13, AfI2C2_SCL_PB13>	;
/// A default configuration to map I2C2 SDA on PB11 pin
using AfI2C2_SDA_PB11 = AnyAltOutOD<Port::PB, 11, AfI2C2_SDA_PB11>	;
/// A default configuration to map I2C2 SDA on PB14 pin
using AfI2C2_SDA_PB14 = AnyAltOutOD<Port::PB, 14, AfI2C2_SDA_PB14>	;
...
using AfI2C2_SCL_PF1 = AnyAltOutOD<Port::PF, 1, AfI2C2_SCL_PF1>	;
...
using AfI2C2_SCL_PH4 = AnyAltOutOD<Port::PH, 4, AfI2C2_SCL_PH4>	;
/// A default configuration to map I2C2 SDA on PH5 pin
using AfI2C2_SDA_PH5 = AnyAltOutOD<Port::PH, 5, AfI2C2_SDA_PH5>	;
/// A default configuration to map I2C2 SMBA on PH6 pin
using AfI2C2_SMBA_PH6 = AnyAltOutOD<Port::PH, 6, AfI2C2_SMBA_PH6>	;
#endif	// defined(GPIOH_BASE)
...
using AfI2C3_SCL_PA7 = AnyAltOutOD<Port::PA, 7, AfI2C3_SCL_PA7>	;
/// A default configuration to map I2C3 SCL on PC0 pin
using AfI2C3_SCL_PC0 = AnyAltOutOD<Port::PC, 0, AfI2C3_SCL_PC0>	;
/// A default configuration to map I2C3 SDA on PB4 pin
using AfI2C3_SDA_PB4 = AnyAltOutOD<Port::PB, 4, AfI2C3_SDA_PB4>	;
/// A default configuration to map I2C3 SDA on PC1 pin
using AfI2C3_SDA_PC1 = AnyAltOutOD<Port::PC, 1, AfI2C3_SDA_PC1>	;
...
using AfI2C3_SCL_PH7 = AnyAltOutOD<Port::PH, 7, AfI2C3_SCL_PH7>	;
/// A default configuration to map I2C3 SDA on PH8 pin
using AfI2C3_SDA_PH8 = AnyAltOutOD<Port::PH, 8, AfI2C3_SDA_PH8>	;
/// A default configuration to map I2C3 SMBA on PH9 pin
using AfI2C3_SMBA_PH9 = AnyAltOutOD<Port::PH, 9, AfI2C3_SMBA_PH9>	;
#endif	// defined(GPIOH_BASE)
...
using AfI2C4_SCL_PB6 = AnyAltOutOD<Port::PB, 6, AfI2C4_SCL_PB6>	;
/// A default configuration to map I2C4 SCL on PB10 pin
using AfI2C4_SCL_PB10 = AnyAltOutOD<Port::PB, 10, AfI2C4_SCL_PB10>	;
/// A default configuration to map I2C4 SCL on PC0 pin
using AfI2C4_SCL_PC0 = AnyAltOutOD<Port::PC, 0, AfI2C4_SCL_PC0>	;
...
using AfI2C4_SDA_PB11 = AnyAltOutOD<Port::PB, 11, AfI2C4_SDA_PB11>	;
/// A default configuration to map I2C4 SDA on PC1 pin
using AfI2C4_SDA_PC1 = AnyAltOutOD<Port::PC, 1, AfI2C4_SDA_PC1>	;
...
using AfI2C4_SCL_PD12 = AnyAltOutOD<Port::PD, 12, AfI2C4_SCL_PD12>	;
/// A default configuration to map I2C4 SDA on PD13 pin
using AfI2C4_SDA_PD13 = AnyAltOutOD<Port::PD, 13, AfI2C4_SDA_PD13>	;
...
using LCD_COM0_PA8 = AnyAltOut<Port::PA, 8, AfLCD_COM0_PA8>	;
/// A default configuration to map LCD COM1 on PA9 pin
using LCD_COM1_PA9 = AnyAltOut<Port::PA, 9, AfLCD_COM1_PA9>	;
/// A default configuration to map LCD COM2 on PA10 pin
using LCD_COM2_PA10 = AnyAltOut<Port::PA, 10, AfLCD_COM2_PA10>	;
/// A default configuration to map LCD COM3 on PB9 pin
using LCD_COM3_PB9 = AnyAltOut<Port::PB, 9, AfLCD_COM3_PB9>	;
/// A default configuration to map LCD COM4 on PC10 pin
using LCD_COM4_PC10 = AnyAltOut<Port::PC, 10, AfLCD_COM4_PC10>	;
/// A default configuration to map LCD COM5 on PC11 pin
using LCD_COM5_PC11 = AnyAltOut<Port::PC, 11, AfLCD_COM5_PC11>	;
/// A default configuration to map LCD COM6 on PC12 pin
using LCD_COM6_PC12 = AnyAltOut<Port::PC, 12, AfLCD_COM6_PC12>	;
/// A default configuration to map LCD SEG0 on PA1 pin
using LCD_SEG0_PA1 = AnyAltOut<Port::PA, 1, AfLCD_SEG0_PA1>	;
/// A default configuration to map LCD SEG1 on PA2 pin
using LCD_SEG1_PA2 = AnyAltOut<Port::PA, 2, AfLCD_SEG1_PA2>	;
/// A default configuration to map LCD SEG10 on PB10 pin
using LCD_SEG10_PB10 = AnyAltOut<Port::PB, 10, AfLCD_SEG10_PB10>	;
/// A default configuration to map LCD SEG11 on PB11 pin
using LCD_SEG11_PB11 = AnyAltOut<Port::PB, 11, AfLCD_SEG11_PB11>	;
/// A default configuration to map LCD SEG12 on PB12 pin
using LCD_SEG12_PB12 = AnyAltOut<Port::PB, 12, AfLCD_SEG12_PB12>	;
/// A default configuration to map LCD SEG13 on PB13 pin
using LCD_SEG13_PB13 = AnyAltOut<Port::PB, 13, AfLCD_SEG13_PB13>	;
/// A default configuration to map LCD SEG14 on PB14 pin
using LCD_SEG14_PB14 = AnyAltOut<Port::PB, 14, AfLCD_SEG14_PB14>	;
/// A default configuration to map LCD SEG15 on PB15 pin
using LCD_SEG15_PB15 = AnyAltOut<Port::PB, 15, AfLCD_SEG15_PB15>	;
/// A default configuration to map LCD SEG16 on PB8 pin
using LCD_SEG16_PB8 = AnyAltOut<Port::PB, 8, AfLCD_SEG16_PB8>	;
/// A default configuration to map LCD SEG17 on PA15 pin
using LCD_SEG17_PA15 = AnyAltOut<Port::PA, 15, AfLCD_SEG17_PA15>	;
/// A default configuration to map LCD SEG18 on PC0 pin
using LCD_SEG18_PC0 = AnyAltOut<Port::PC, 0, AfLCD_SEG18_PC0>	;
/// A default configuration to map LCD SEG19 on PC1 pin
using LCD_SEG19_PC1 = AnyAltOut<Port::PC, 1, AfLCD_SEG19_PC1>	;
/// A default configuration to map LCD SEG2 on PA3 pin
using LCD_SEG2_PA3 = AnyAltOut<Port::PA, 3, AfLCD_SEG2_PA3>	;
/// A default configuration to map LCD SEG20 on PC2 pin
using LCD_SEG20_PC2 = AnyAltOut<Port::PC, 2, AfLCD_SEG20_PC2>	;
/// A default configuration to map LCD SEG21 on PB7 pin
using LCD_SEG21_PB7 = AnyAltOut<Port::PB, 7, AfLCD_SEG21_PB7>	;
/// A default configuration to map LCD SEG22 on PC4 pin
using LCD_SEG22_PC4 = AnyAltOut<Port::PC, 4, AfLCD_SEG22_PC4>	;
/// A default configuration to map LCD SEG23 on PC5 pin
using LCD_SEG23_PC5 = AnyAltOut<Port::PC, 5, AfLCD_SEG23_PC5>	;
/// A default configuration to map LCD SEG24 on PC6 pin
using LCD_SEG24_PC6 = AnyAltOut<Port::PC, 6, AfLCD_SEG24_PC6>	;
/// A default configuration to map LCD SEG25 on PC7 pin
using LCD_SEG25_PC7 = AnyAltOut<Port::PC, 7, AfLCD_SEG25_PC7>	;
/// A default configuration to map LCD SEG26 on PC8 pin
using LCD_SEG26_PC8 = AnyAltOut<Port::PC, 8, AfLCD_SEG26_PC8>	;
/// A default configuration to map LCD SEG27 on PC9 pin
using LCD_SEG27_PC9 = AnyAltOut<Port::PC, 9, AfLCD_SEG27_PC9>	;
/// A default configuration to map LCD SEG28 on PC10 pin
using LCD_SEG28_PC10 = AnyAltOut<Port::PC, 10, AfLCD_SEG28_PC10>	;
/// A default configuration to map LCD SEG29 on PC11 pin
using LCD_SEG29_PC11 = AnyAltOut<Port::PC, 11, AfLCD_SEG29_PC11>	;
/// A default configuration to map LCD SEG3 on PA6 pin
using LCD_SEG3_PA6 = AnyAltOut<Port::PA, 6, AfLCD_SEG3_PA6>	;
/// A default configuration to map LCD SEG30 on PC12 pin
using LCD_SEG30_PC12 = AnyAltOut<Port::PC, 12, AfLCD_SEG30_PC12>	;
/// A default configuration to map LCD SEG4 on PA7 pin
using LCD_SEG4_PA7 = AnyAltOut<Port::PA, 7, AfLCD_SEG4_PA7>	;
/// A default configuration to map LCD SEG40 on PC10 pin
using LCD_SEG40_PC10 = AnyAltOut<Port::PC, 10, AfLCD_SEG40_PC10>	;
/// A default configuration to map LCD SEG41 on PC11 pin
using LCD_SEG41_PC11 = AnyAltOut<Port::PC, 11, AfLCD_SEG41_PC11>	;
/// A default configuration to map LCD SEG42 on PC12 pin
using LCD_SEG42_PC12 = AnyAltOut<Port::PC, 12, AfLCD_SEG42_PC12>	;
/// A default configuration to map LCD SEG5 on PB0 pin
using LCD_SEG5_PB0 = AnyAltOut<Port::PB, 0, AfLCD_SEG5_PB0>	;
/// A default configuration to map LCD SEG6 on PB1 pin
using LCD_SEG6_PB1 = AnyAltOut<Port::PB, 1, AfLCD_SEG6_PB1>	;
/// A default configuration to map LCD SEG7 on PB3 pin
using LCD_SEG7_PB3 = AnyAltOut<Port::PB, 3, AfLCD_SEG7_PB3>	;
/// A default configuration to map LCD SEG8 on PB4 pin
using LCD_SEG8_PB4 = AnyAltOut<Port::PB, 4, AfLCD_SEG8_PB4>	;
/// A default configuration to map LCD SEG9 on PB5 pin
using LCD_SEG9_PB5 = AnyAltOut<Port::PB, 5, AfLCD_SEG9_PB5>	;
/// A default configuration to map LCD VLCD on PB2 pin
using LCD_VLCD_PB2 = AnyAltOut<Port::PB, 2, AfLCD_VLCD_PB2>	;
/// A default configuration to map LCD VLCD on PC3 pin
using LCD_VLCD_PC3 = AnyAltOut<Port::PC, 3, AfLCD_VLCD_PC3>	;
#if defined(GPIOD_BASE)
/// A default configuration to map LCD COM7 on PD2 pin
using LCD_COM7_PD2 = AnyAltOut<Port::PD, 2, AfLCD_COM7_PD2>	;
/// A default configuration to map LCD SEG28 on PD8 pin
using LCD_SEG28_PD8 = AnyAltOut<Port::PD, 8, AfLCD_SEG28_PD8>	;
/// A default configuration to map LCD SEG29 on PD9 pin
using LCD_SEG29_PD9 = AnyAltOut<Port::PD, 9, AfLCD_SEG29_PD9>	;
/// A default configuration to map LCD SEG30 on PD10 pin
using LCD_SEG30_PD10 = AnyAltOut<Port::PD, 10, AfLCD_SEG30_PD10>	;
/// A default configuration to map LCD SEG31 on PD2 pin
using LCD_SEG31_PD2 = AnyAltOut<Port::PD, 2, AfLCD_SEG31_PD2>	;
/// A default configuration to map LCD SEG31 on PD11 pin
using LCD_SEG31_PD11 = AnyAltOut<Port::PD, 11, AfLCD_SEG31_PD11>	;
/// A default configuration to map LCD SEG32 on PD12 pin
using LCD_SEG32_PD12 = AnyAltOut<Port::PD, 12, AfLCD_SEG32_PD12>	;
/// A default configuration to map LCD SEG33 on PD13 pin
using LCD_SEG33_PD13 = AnyAltOut<Port::PD, 13, AfLCD_SEG33_PD13>	;
/// A default configuration to map LCD SEG34 on PD14 pin
using LCD_SEG34_PD14 = AnyAltOut<Port::PD, 14, AfLCD_SEG34_PD14>	;
/// A default configuration to map LCD SEG35 on PD15 pin
using LCD_SEG35_PD15 = AnyAltOut<Port::PD, 15, AfLCD_SEG35_PD15>	;
/// A default configuration to map LCD SEG43 on PD2 pin
using LCD_SEG43_PD2 = AnyAltOut<Port::PD, 2, AfLCD_SEG43_PD2>	;
#endif	// defined(GPIOD_BASE)
#if defined(GPIOE_BASE)
/// A default configuration to map LCD SEG36 on PE0 pin
using LCD_SEG36_PE0 = AnyAltOut<Port::PE, 0, AfLCD_SEG36_PE0>	;
/// A default configuration to map LCD SEG37 on PE1 pin
using LCD_SEG37_PE1 = AnyAltOut<Port::PE, 1, AfLCD_SEG37_PE1>	;
/// A default configuration to map LCD SEG38 on PE2 pin
using LCD_SEG38_PE2 = AnyAltOut<Port::PE, 2, AfLCD_SEG38_PE2>	;
/// A default configuration to map LCD SEG39 on PE3 pin
using LCD_SEG39_PE3 = AnyAltOut<Port::PE, 3, AfLCD_SEG39_PE3>	;
#endif	// defined(GPIOE_BASE)
...
using LPTIM1_ETR_PG12 = AnyAltOut<Port::PG, 12, AfLPTIM1_ETR_PG12>	;
/// A default configuration to map LPTIM1 IN1 on PG10 pin
using LPTIM1_IN1_PG10 = AnyAltOut<Port::PG, 10, AfLPTIM1_IN1_PG10>	;
/// A default configuration to map LPTIM1 IN2 on PG11 pin
using LPTIM1_IN2_PG11 = AnyAltOut<Port::PG, 11, AfLPTIM1_IN2_PG11>	;
/// A default configuration to map LPTIM1 OUT on PG15 pin
using LPTIM1_OUT_PG15 = AnyAltOut<Port::PG, 15, AfLPTIM1_OUT_PG15>	;
#endif	// defined(GPIOG_BASE)
...
using LPTIM2_ETR_PA5 = AnyAltOut<Port::PA, 5, AfLPTIM2_ETR_PA5>	;
/// A default configuration to map LPTIM2 ETR on PC3 pin
using LPTIM2_ETR_PC3 = AnyAltOut<Port::PC, 3, AfLPTIM2_ETR_PC3>	;
/// A default configuration to map LPTIM2 IN1 on PB1 pin
using LPTIM2_IN1_PB1 = AnyAltOut<Port::PB, 1, AfLPTIM2_IN1_PB1>	;
/// A default configuration to map LPTIM2 IN1 on PC0 pin
using LPTIM2_IN1_PC0 = AnyAltOut<Port::PC, 0, AfLPTIM2_IN1_PC0>	;
/// A default configuration to map LPTIM2 OUT on PA4 pin
using LPTIM2_OUT_PA4 = AnyAltOut<Port::PA, 4, AfLPTIM2_OUT_PA4>	;
/// A default configuration to map LPTIM2 OUT on PA8 pin
using LPTIM2_OUT_PA8 = AnyAltOut<Port::PA, 8, AfLPTIM2_OUT_PA8>	;
#if defined(GPIOD_BASE)
/// A default configuration to map LPTIM2 ETR on PD11 pin
using LPTIM2_ETR_PD11 = AnyAltOut<Port::PD, 11, AfLPTIM2_ETR_PD11>	;
/// A default configuration to map LPTIM2 IN1 on PD12 pin
using LPTIM2_IN1_PD12 = AnyAltOut<Port::PD, 12, AfLPTIM2_IN1_PD12>	;
/// A default configuration to map LPTIM2 OUT on PD13 pin
using LPTIM2_OUT_PD13 = AnyAltOut<Port::PD, 13, AfLPTIM2_OUT_PD13>	;
#endif	// defined(GPIOD_BASE)
...
using LPUART1_DE_PB1 = AnyAltOut<Port::PB, 1, AfLPUART1_DE_PB1>	;
/// A default configuration to map LPUART1 DE on PB12 pin
using LPUART1_DE_PB12 = AnyAltOut<Port::PB, 12, AfLPUART1_DE_PB12>	;
/// A default configuration to map LPUART1 RTS on PB1 pin
using LPUART1_RTS_PB1 = AnyAltOut<Port::PB, 1, AfLPUART1_RTS_PB1>	;
/// A default configuration to map LPUART1 RTS on PB12 pin
using LPUART1_RTS_PB12 = AnyAltOut<Port::PB, 12, AfLPUART1_RTS_PB12>	;
...
using LPUART1_DE_PG6 = AnyAltOut<Port::PG, 6, AfLPUART1_DE_PG6>	;
/// A default configuration to map LPUART1 RTS on PG6 pin
using LPUART1_RTS_PG6 = AnyAltOut<Port::PG, 6, AfLPUART1_RTS_PG6>	;
...
using OTG_FS_CRS_SYNC_PB3 = AnyAltOut<Port::PB, 3, AfOTG_FS_CRS_SYNC_PB3>	;
/// A default configuration to map OTG FS_DM on PA11 pin
using OTG_FS_DM_PA11 = AnyAltOut<Port::PA, 11, AfOTG_FS_DM_PA11>	;
/// A default configuration to map OTG FS_DP on PA12 pin
using OTG_FS_DP_PA12 = AnyAltOut<Port::PA, 12, AfOTG_FS_DP_PA12>	;
/// A default configuration to map OTG FS_ID on PA10 pin
using OTG_FS_ID_PA10 = AnyAltOut<Port::PA, 10, AfOTG_FS_ID_PA10>	;
/// A default configuration to map OTG FS_NOE on PA13 pin
using OTG_FS_NOE_PA13 = AnyAltOut<Port::PA, 13, AfOTG_FS_NOE_PA13>	;
/// A default configuration to map OTG FS_NOE on PC9 pin
using OTG_FS_NOE_PC9 = AnyAltOut<Port::PC, 9, AfOTG_FS_NOE_PC9>	;
/// A default configuration to map OTG FS_SOF on PA8 pin
using OTG_FS_SOF_PA8 = AnyAltOut<Port::PA, 8, AfOTG_FS_SOF_PA8>	;
/// A default configuration to map OTG FS_SOF on PA14 pin
using OTG_FS_SOF_PA14 = AnyAltOut<Port::PA, 14, AfOTG_FS_SOF_PA14>	;
...
using QUADSPI_BK1_IO0_PB1 = AnyAltOut<Port::PB, 1, AfQUADSPI_BK1_IO0_PB1>	;
/// A default configuration to map QUADSPI BK1_IO1 on PB0 pin
using QUADSPI_BK1_IO1_PB0 = AnyAltOut<Port::PB, 0, AfQUADSPI_BK1_IO1_PB0>	;
/// A default configuration to map QUADSPI BK1_IO2 on PA7 pin
using QUADSPI_BK1_IO2_PA7 = AnyAltOut<Port::PA, 7, AfQUADSPI_BK1_IO2_PA7>	;
/// A default configuration to map QUADSPI BK1_IO3 on PA6 pin
using QUADSPI_BK1_IO3_PA6 = AnyAltOut<Port::PA, 6, AfQUADSPI_BK1_IO3_PA6>	;
/// A default configuration to map QUADSPI BK1_NCS on PA2 pin
using QUADSPI_BK1_NCS_PA2 = AnyAltOut<Port::PA, 2, AfQUADSPI_BK1_NCS_PA2>	;
/// A default configuration to map QUADSPI BK1_NCS on PB11 pin
using QUADSPI_BK1_NCS_PB11 = AnyAltOut<Port::PB, 11, AfQUADSPI_BK1_NCS_PB11>	;
/// A default configuration to map QUADSPI BK2_IO0 on PC1 pin
using QUADSPI_BK2_IO0_PC1 = AnyAltOut<Port::PC, 1, AfQUADSPI_BK2_IO0_PC1>	;
/// A default configuration to map QUADSPI BK2_IO1 on PC2 pin
using QUADSPI_BK2_IO1_PC2 = AnyAltOut<Port::PC, 2, AfQUADSPI_BK2_IO1_PC2>	;
/// A default configuration to map QUADSPI BK2_IO2 on PC3 pin
using QUADSPI_BK2_IO2_PC3 = AnyAltOut<Port::PC, 3, AfQUADSPI_BK2_IO2_PC3>	;
/// A default configuration to map QUADSPI BK2_IO3 on PC4 pin
using QUADSPI_BK2_IO3_PC4 = AnyAltOut<Port::PC, 4, AfQUADSPI_BK2_IO3_PC4>	;
/// A default configuration to map QUADSPI BK2_NCS on PC11 pin
using QUADSPI_BK2_NCS_PC11 = AnyAltOut<Port::PC, 11, AfQUADSPI_BK2_NCS_PC11>	;
/// A default configuration to map QUADSPI CLK on PA3 pin
using QUADSPI_CLK_PA3 = AnyAltOut<Port::PA, 3, AfQUADSPI_CLK_PA3>	;
/// A default configuration to map QUADSPI CLK on PB10 pin
using QUADSPI_CLK_PB10 = AnyAltOut<Port::PB, 10, AfQUADSPI_CLK_PB10>	;
#if defined(GPIOD_BASE)
/// A default configuration to map QUADSPI BK2_IO0 on PD4 pin
using QUADSPI_BK2_IO0_PD4 = AnyAltOut<Port::PD, 4, AfQUADSPI_BK2_IO0_PD4>	;
/// A default configuration to map QUADSPI BK2_IO1 on PD5 pin
using QUADSPI_BK2_IO1_PD5 = AnyAltOut<Port::PD, 5, AfQUADSPI_BK2_IO1_PD5>	;
/// A default configuration to map QUADSPI BK2_IO1 on PD6 pin
using QUADSPI_BK2_IO1_PD6 = AnyAltOut<Port::PD, 6, AfQUADSPI_BK2_IO1_PD6>	;
/// A default configuration to map QUADSPI BK2_IO2 on PD6 pin
using QUADSPI_BK2_IO2_PD6 = AnyAltOut<Port::PD, 6, AfQUADSPI_BK2_IO2_PD6>	;
/// A default configuration to map QUADSPI BK2_IO3 on PD7 pin
using QUADSPI_BK2_IO3_PD7 = AnyAltOut<Port::PD, 7, AfQUADSPI_BK2_IO3_PD7>	;
/// A default configuration to map QUADSPI BK2_NCS on PD3 pin
using QUADSPI_BK2_NCS_PD3 = AnyAltOut<Port::PD, 3, AfQUADSPI_BK2_NCS_PD3>	;
#endif	// defined(GPIOD_BASE)
#if defined(GPIOE_BASE)
/// A default configuration to map QUADSPI BK1_IO0 on PE12 pin
using QUADSPI_BK1_IO0_PE12 = AnyAltOut<Port::PE, 12, AfQUADSPI_BK1_IO0_PE12>	;
/// A default configuration to map QUADSPI BK1_IO1 on PE13 pin
using QUADSPI_BK1_IO1_PE13 = AnyAltOut<Port::PE, 13, AfQUADSPI_BK1_IO1_PE13>	;
/// A default configuration to map QUADSPI BK1_IO2 on PE14 pin
using QUADSPI_BK1_IO2_PE14 = AnyAltOut<Port::PE, 14, AfQUADSPI_BK1_IO2_PE14>	;
/// A default configuration to map QUADSPI BK1_IO3 on PE15 pin
using QUADSPI_BK1_IO3_PE15 = AnyAltOut<Port::PE, 15, AfQUADSPI_BK1_IO3_PE15>	;
/// A default configuration to map QUADSPI BK1_NCS on PE11 pin
using QUADSPI_BK1_NCS_PE11 = AnyAltOut<Port::PE, 11, AfQUADSPI_BK1_NCS_PE11>	;
/// A default configuration to map QUADSPI CLK on PE10 pin
using QUADSPI_CLK_PE10 = AnyAltOut<Port::PE, 10, AfQUADSPI_CLK_PE10>	;
#endif	// defined(GPIOE_BASE)
#if defined(GPIOF_BASE)
/// A default configuration to map QUADSPI BK1_IO0 on PF8 pin
using QUADSPI_BK1_IO0_PF8 = AnyAltOut<Port::PF, 8, AfQUADSPI_BK1_IO0_PF8>	;
/// A default configuration to map QUADSPI BK1_IO1 on PF9 pin
using QUADSPI_BK1_IO1_PF9 = AnyAltOut<Port::PF, 9, AfQUADSPI_BK1_IO1_PF9>	;
/// A default configuration to map QUADSPI BK1_IO2 on PF7 pin
using QUADSPI_BK1_IO2_PF7 = AnyAltOut<Port::PF, 7, AfQUADSPI_BK1_IO2_PF7>	;
/// A default configuration to map QUADSPI BK1_IO3 on PF6 pin
using QUADSPI_BK1_IO3_PF6 = AnyAltOut<Port::PF, 6, AfQUADSPI_BK1_IO3_PF6>	;
/// A default configuration to map QUADSPI CLK on PF10 pin
using QUADSPI_CLK_PF10 = AnyAltOut<Port::PF, 10, AfQUADSPI_CLK_PF10>	;
#endif	// defined(GPIOF_BASE)
#if defined(GPIOH_BASE)
/// A default configuration to map QUADSPI BK2_IO0 on PH2 pin
using QUADSPI_BK2_IO0_PH2 = AnyAltOut<Port::PH, 2, AfQUADSPI_BK2_IO0_PH2>	;
#endif	// defined(GPIOH_BASE)
...
using RTC_OUT_PB2 = AnyAltOut<Port::PB, 2, AfRTC_OUT_PB2>	;
...
using SAI1_EXTCLK_PA0 = AnyAltOut<Port::PA, 0, AfSAI1_EXTCLK_PA0>	;
/// A default configuration to map SAI1 EXTCLK on PB0 pin
using SAI1_EXTCLK_PB0 = AnyAltOut<Port::PB, 0, AfSAI1_EXTCLK_PB0>	;
...
using SAI2_EXTCLK_PA2 = AnyAltOut<Port::PA, 2, AfSAI2_EXTCLK_PA2>	;
/// A default configuration to map SAI2 EXTCLK on PC9 pin
using SAI2_EXTCLK_PC9 = AnyAltOut<Port::PC, 9, AfSAI2_EXTCLK_PC9>	;
/// A default configuration to map SAI2 FS_A on PB12 pin
using SAI2_FS_A_PB12 = AnyAltOut<Port::PB, 12, AfSAI2_FS_A_PB12>	;
/// A default configuration to map SAI2 FS_B on PA15 pin
using SAI2_FS_B_PA15 = AnyAltOut<Port::PA, 15, AfSAI2_FS_B_PA15>	;
/// A default configuration to map SAI2 MCLK_A on PB14 pin
using SAI2_MCLK_A_PB14 = AnyAltOut<Port::PB, 14, AfSAI2_MCLK_A_PB14>	;
/// A default configuration to map SAI2 MCLK_A on PC6 pin
using SAI2_MCLK_A_PC6 = AnyAltOut<Port::PC, 6, AfSAI2_MCLK_A_PC6>	;
/// A default configuration to map SAI2 MCLK_B on PC7 pin
using SAI2_MCLK_B_PC7 = AnyAltOut<Port::PC, 7, AfSAI2_MCLK_B_PC7>	;
/// A default configuration to map SAI2 MCLK_B on PC11 pin
using SAI2_MCLK_B_PC11 = AnyAltOut<Port::PC, 11, AfSAI2_MCLK_B_PC11>	;
/// A default configuration to map SAI2 SCK_A on PB13 pin
using SAI2_SCK_A_PB13 = AnyAltOut<Port::PB, 13, AfSAI2_SCK_A_PB13>	;
/// A default configuration to map SAI2 SCK_B on PC10 pin
using SAI2_SCK_B_PC10 = AnyAltOut<Port::PC, 10, AfSAI2_SCK_B_PC10>	;
/// A default configuration to map SAI2 SD_A on PB15 pin
using SAI2_SD_A_PB15 = AnyAltOut<Port::PB, 15, AfSAI2_SD_A_PB15>	;
/// A default configuration to map SAI2 SD_B on PC12 pin
using SAI2_SD_B_PC12 = AnyAltOut<Port::PC, 12, AfSAI2_SD_B_PC12>	;
#if defined(GPIOD_BASE)
/// A default configuration to map SAI2 FS_A on PD12 pin
using SAI2_FS_A_PD12 = AnyAltOut<Port::PD, 12, AfSAI2_FS_A_PD12>	;
/// A default configuration to map SAI2 MCLK_A on PD9 pin
using SAI2_MCLK_A_PD9 = AnyAltOut<Port::PD, 9, AfSAI2_MCLK_A_PD9>	;
/// A default configuration to map SAI2 SCK_A on PD10 pin
using SAI2_SCK_A_PD10 = AnyAltOut<Port::PD, 10, AfSAI2_SCK_A_PD10>	;
/// A default configuration to map SAI2 SD_A on PD11 pin
using SAI2_SD_A_PD11 = AnyAltOut<Port::PD, 11, AfSAI2_SD_A_PD11>	;
#endif	// defined(GPIOD_BASE)
#if defined(GPIOG_BASE)
/// A default configuration to map SAI2 FS_A on PG10 pin
using SAI2_FS_A_PG10 = AnyAltOut<Port::PG, 10, AfSAI2_FS_A_PG10>	;
/// A default configuration to map SAI2 FS_B on PG3 pin
using SAI2_FS_B_PG3 = AnyAltOut<Port::PG, 3, AfSAI2_FS_B_PG3>	;
/// A default configuration to map SAI2 MCLK_A on PG11 pin
using SAI2_MCLK_A_PG11 = AnyAltOut<Port::PG, 11, AfSAI2_MCLK_A_PG11>	;
/// A default configuration to map SAI2 MCLK_B on PG4 pin
using SAI2_MCLK_B_PG4 = AnyAltOut<Port::PG, 4, AfSAI2_MCLK_B_PG4>	;
/// A default configuration to map SAI2 SCK_A on PG9 pin
using SAI2_SCK_A_PG9 = AnyAltOut<Port::PG, 9, AfSAI2_SCK_A_PG9>	;
/// A default configuration to map SAI2 SCK_B on PG2 pin
using SAI2_SCK_B_PG2 = AnyAltOut<Port::PG, 2, AfSAI2_SCK_B_PG2>	;
/// A default configuration to map SAI2 SD_A on PG12 pin
using SAI2_SD_A_PG12 = AnyAltOut<Port::PG, 12, AfSAI2_SD_A_PG12>	;
/// A default configuration to map SAI2 SD_B on PG5 pin
using SAI2_SD_B_PG5 = AnyAltOut<Port::PG, 5, AfSAI2_SD_B_PG5>	;
#endif	// defined(GPIOG_BASE)
...
using SDMMC1_CK_PC12 = AnyAltOut<Port::PC, 12, AfSDMMC1_CK_PC12>	;
/// A default configuration to map SDMMC1 D0 on PC8 pin
using SDMMC1_D0_PC8 = AnyAltOut<Port::PC, 8, AfSDMMC1_D0_PC8>	;
/// A default configuration to map SDMMC1 D1 on PC9 pin
using SDMMC1_D1_PC9 = AnyAltOut<Port::PC, 9, AfSDMMC1_D1_PC9>	;
/// A default configuration to map SDMMC1 D2 on PC10 pin
using SDMMC1_D2_PC10 = AnyAltOut<Port::PC, 10, AfSDMMC1_D2_PC10>	;
/// A default configuration to map SDMMC1 D3 on PC11 pin
using SDMMC1_D3_PC11 = AnyAltOut<Port::PC, 11, AfSDMMC1_D3_PC11>	;
/// A default configuration to map SDMMC1 D4 on PB8 pin
using SDMMC1_D4_PB8 = AnyAltOut<Port::PB, 8, AfSDMMC1_D4_PB8>	;
/// A default configuration to map SDMMC1 D5 on PB9 pin
using SDMMC1_D5_PB9 = AnyAltOut<Port::PB, 9, AfSDMMC1_D5_PB9>	;
/// A default configuration to map SDMMC1 D6 on PC6 pin
using SDMMC1_D6_PC6 = AnyAltOut<Port::PC, 6, AfSDMMC1_D6_PC6>	;
/// A default configuration to map SDMMC1 D7 on PC7 pin
using SDMMC1_D7_PC7 = AnyAltOut<Port::PC, 7, AfSDMMC1_D7_PC7>	;
#if defined(GPIOD_BASE)
/// A default configuration to map SDMMC1 CMD on PD2 pin
using SDMMC1_CMD_PD2 = AnyAltOut<Port::PD, 2, AfSDMMC1_CMD_PD2>	;
#endif	// defined(GPIOD_BASE)
...
using SPI1_MISO_PA11 = AnyAltOut<Port::PA, 11, AfSPI1_MISO_PA11>	;
...
using SPI1_MOSI_PA12 = AnyAltOut<Port::PA, 12, AfSPI1_MOSI_PA12>	;
...
using SPI1_NSS_PB0 = AnyAltOut<Port::PB, 0, AfSPI1_NSS_PB0>	;
/// A default configuration to map SPI1 SCK on PA1 pin
using SPI1_SCK_PA1 = AnyAltOut<Port::PA, 1, AfSPI1_SCK_PA1>	;
...
using SPI1_MISO_PE14 = AnyAltOut<Port::PE, 14, AfSPI1_MISO_PE14>	;
/// A default configuration to map SPI1 MOSI on PE15 pin
using SPI1_MOSI_PE15 = AnyAltOut<Port::PE, 15, AfSPI1_MOSI_PE15>	;
/// A default configuration to map SPI1 NSS on PE12 pin
using SPI1_NSS_PE12 = AnyAltOut<Port::PE, 12, AfSPI1_NSS_PE12>	;
/// A default configuration to map SPI1 SCK on PE13 pin
using SPI1_SCK_PE13 = AnyAltOut<Port::PE, 13, AfSPI1_SCK_PE13>	;
#endif	// defined(GPIOE_BASE)
#if defined(GPIOG_BASE)
...
using SPI2_MISO_PC2 = AnyAltOut<Port::PC, 2, AfSPI2_MISO_PC2>	;
...
using SPI2_MOSI_PC1 = AnyAltOut<Port::PC, 1, AfSPI2_MOSI_PC1>	;
/// A default configuration to map SPI2 MOSI on PC3 pin
using SPI2_MOSI_PC3 = AnyAltOut<Port::PC, 3, AfSPI2_MOSI_PC3>	;
/// A default configuration to map SPI2 NSS on PB9 pin
using SPI2_NSS_PB9 = AnyAltOut<Port::PB, 9, AfSPI2_NSS_PB9>	;
...
using SPI2_SCK_PA9 = AnyAltOut<Port::PA, 9, AfSPI2_SCK_PA9>	;
/// A default configuration to map SPI2 SCK on PB10 pin
using SPI2_SCK_PB10 = AnyAltOut<Port::PB, 10, AfSPI2_SCK_PB10>	;
...
using SPI2_MISO_PD3 = AnyAltOut<Port::PD, 3, AfSPI2_MISO_PD3>	;
/// A default configuration to map SPI2 MOSI on PD4 pin
using SPI2_MOSI_PD4 = AnyAltOut<Port::PD, 4, AfSPI2_MOSI_PD4>	;
/// A default configuration to map SPI2 NSS on PD0 pin
using SPI2_NSS_PD0 = AnyAltOut<Port::PD, 0, AfSPI2_NSS_PD0>	;
/// A default configuration to map SPI2 SCK on PD1 pin
using SPI2_SCK_PD1 = AnyAltOut<Port::PD, 1, AfSPI2_SCK_PD1>	;
/// A default configuration to map SPI2 SCK on PD3 pin
using SPI2_SCK_PD3 = AnyAltOut<Port::PD, 3, AfSPI2_SCK_PD3>	;
#endif	// defined(GPIOD_BASE)
#if defined(GPIOI_BASE)
/// A default configuration to map SPI2 MISO on PI2 pin
using SPI2_MISO_PI2 = AnyAltOut<Port::PI, 2, AfSPI2_MISO_PI2>	;
/// A default configuration to map SPI2 MOSI on PI3 pin
using SPI2_MOSI_PI3 = AnyAltOut<Port::PI, 3, AfSPI2_MOSI_PI3>	;
/// A default configuration to map SPI2 NSS on PI0 pin
using SPI2_NSS_PI0 = AnyAltOut<Port::PI, 0, AfSPI2_NSS_PI0>	;
/// A default configuration to map SPI2 SCK on PI1 pin
using SPI2_SCK_PI1 = AnyAltOut<Port::PI, 1, AfSPI2_SCK_PI1>	;
#endif	// defined(GPIOI_BASE)
...
using SPI3_MISO_PG10 = AnyAltOut<Port::PG, 10, AfSPI3_MISO_PG10>	;
/// A default configuration to map SPI3 MOSI on PG11 pin
using SPI3_MOSI_PG11 = AnyAltOut<Port::PG, 11, AfSPI3_MOSI_PG11>	;
/// A default configuration to map SPI3 NSS on PG12 pin
using SPI3_NSS_PG12 = AnyAltOut<Port::PG, 12, AfSPI3_NSS_PG12>	;
...
using SWPMI1_IO_PA8 = AnyAltOut<Port::PA, 8, AfSWPMI1_IO_PA8>	;
/// A default configuration to map SWPMI1 IO on PB12 pin
using SWPMI1_IO_PB12 = AnyAltOut<Port::PB, 12, AfSWPMI1_IO_PB12>	;
/// A default configuration to map SWPMI1 RX on PA14 pin
using SWPMI1_RX_PA14 = AnyAltOut<Port::PA, 14, AfSWPMI1_RX_PA14>	;
/// A default configuration to map SWPMI1 RX on PB14 pin
using SWPMI1_RX_PB14 = AnyAltOut<Port::PB, 14, AfSWPMI1_RX_PB14>	;
/// A default configuration to map SWPMI1 SUSPEND on PA15 pin
using SWPMI1_SUSPEND_PA15 = AnyAltOut<Port::PA, 15, AfSWPMI1_SUSPEND_PA15>	;
/// A default configuration to map SWPMI1 SUSPEND on PB15 pin
using SWPMI1_SUSPEND_PB15 = AnyAltOut<Port::PB, 15, AfSWPMI1_SUSPEND_PB15>	;
/// A default configuration to map SWPMI1 TX on PA13 pin
using SWPMI1_TX_PA13 = AnyAltOut<Port::PA, 13, AfSWPMI1_TX_PA13>	;
/// A default configuration to map SWPMI1 TX on PB13 pin
using SWPMI1_TX_PB13 = AnyAltOut<Port::PB, 13, AfSWPMI1_TX_PB13>	;
...
using TIM1_BKIN2_COMP1_PA11 = AnyAltOut<Port::PA, 11, AfTIM1_BKIN2_COMP1_PA11>	;
/// A default configuration to map TIM1 BKIN_COMP2 on PA6 pin
using TIM1_BKIN_COMP2_PA6 = AnyAltOut<Port::PA, 6, AfTIM1_BKIN_COMP2_PA6>	;
/// A default configuration to map TIM1 BKIN_COMP2 on PB12 pin
using TIM1_BKIN_COMP2_PB12 = AnyAltOut<Port::PB, 12, AfTIM1_BKIN_COMP2_PB12>	;
...
using TIM1_BKIN2_COMP2_PE14 = AnyAltOut<Port::PE, 14, AfTIM1_BKIN2_COMP2_PE14>	;
/// A default configuration to map TIM1 BKIN_COMP1 on PE15 pin
using TIM1_BKIN_COMP1_PE15 = AnyAltOut<Port::PE, 15, AfTIM1_BKIN_COMP1_PE15>	;
...
#endif	// defined(GPIOD_BASE)
#if defined(GPIOE_BASE)
/// A generic configuration to map TIM3 CH1 on PE3 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM3_CH1_PE3 : AnyPin<Port::PE, 3, kMode, kSpeed, kPuPd, kLevel, AfTIM3_CH1_PE3> {};
/// A default configuration to map TIM3 CH1 on PE3 pin (output)
using TIM3_CH1_PE3_OUT = TIM3_CH1_PE3<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM3 CH1 on PE3 pin (input)
using TIM3_CH1_PE3_IN = TIM3_CH1_PE3<Mode::kInput, Speed::kInput>	;

/// A generic configuration to map TIM3 CH2 on PE4 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM3_CH2_PE4 : AnyPin<Port::PE, 4, kMode, kSpeed, kPuPd, kLevel, AfTIM3_CH2_PE4> {};
/// A default configuration to map TIM3 CH2 on PE4 pin (output)
using TIM3_CH2_PE4_OUT = TIM3_CH2_PE4<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM3 CH2 on PE4 pin (input)
using TIM3_CH2_PE4_IN = TIM3_CH2_PE4<Mode::kInput, Speed::kInput>	;

/// A generic configuration to map TIM3 CH3 on PE5 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM3_CH3_PE5 : AnyPin<Port::PE, 5, kMode, kSpeed, kPuPd, kLevel, AfTIM3_CH3_PE5> {};
/// A default configuration to map TIM3 CH3 on PE5 pin (output)
using TIM3_CH3_PE5_OUT = TIM3_CH3_PE5<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM3 CH3 on PE5 pin (input)
using TIM3_CH3_PE5_IN = TIM3_CH3_PE5<Mode::kInput, Speed::kInput>	;

/// A generic configuration to map TIM3 CH4 on PE6 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM3_CH4_PE6 : AnyPin<Port::PE, 6, kMode, kSpeed, kPuPd, kLevel, AfTIM3_CH4_PE6> {};
/// A default configuration to map TIM3 CH4 on PE6 pin (output)
using TIM3_CH4_PE6_OUT = TIM3_CH4_PE6<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM3 CH4 on PE6 pin (input)
using TIM3_CH4_PE6_IN = TIM3_CH4_PE6<Mode::kInput, Speed::kInput>	;

/// A default configuration to map TIM3 ETR on PE2 pin
using TIM3_ETR_PE2 = AnyAltOut<Port::PE, 2, AfTIM3_ETR_PE2>	;
#endif	// defined(GPIOE_BASE)
...
#endif	// defined(GPIOF_BASE)
#if defined(GPIOH_BASE)
/// A generic configuration to map TIM5 CH1 on PH10 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM5_CH1_PH10 : AnyPin<Port::PH, 10, kMode, kSpeed, kPuPd, kLevel, AfTIM5_CH1_PH10> {};
/// A default configuration to map TIM5 CH1 on PH10 pin (output)
using TIM5_CH1_PH10_OUT = TIM5_CH1_PH10<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM5 CH1 on PH10 pin (input)
using TIM5_CH1_PH10_IN = TIM5_CH1_PH10<Mode::kInput, Speed::kInput>	;

/// A generic configuration to map TIM5 CH2 on PH11 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM5_CH2_PH11 : AnyPin<Port::PH, 11, kMode, kSpeed, kPuPd, kLevel, AfTIM5_CH2_PH11> {};
/// A default configuration to map TIM5 CH2 on PH11 pin (output)
using TIM5_CH2_PH11_OUT = TIM5_CH2_PH11<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM5 CH2 on PH11 pin (input)
using TIM5_CH2_PH11_IN = TIM5_CH2_PH11<Mode::kInput, Speed::kInput>	;

/// A generic configuration to map TIM5 CH3 on PH12 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM5_CH3_PH12 : AnyPin<Port::PH, 12, kMode, kSpeed, kPuPd, kLevel, AfTIM5_CH3_PH12> {};
/// A default configuration to map TIM5 CH3 on PH12 pin (output)
using TIM5_CH3_PH12_OUT = TIM5_CH3_PH12<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM5 CH3 on PH12 pin (input)
using TIM5_CH3_PH12_IN = TIM5_CH3_PH12<Mode::kInput, Speed::kInput>	;

#endif	// defined(GPIOH_BASE)
#if defined(GPIOI_BASE)
/// A generic configuration to map TIM5 CH4 on PI0 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM5_CH4_PI0 : AnyPin<Port::PI, 0, kMode, kSpeed, kPuPd, kLevel, AfTIM5_CH4_PI0> {};
/// A default configuration to map TIM5 CH4 on PI0 pin (output)
using TIM5_CH4_PI0_OUT = TIM5_CH4_PI0<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM5 CH4 on PI0 pin (input)
using TIM5_CH4_PI0_IN = TIM5_CH4_PI0<Mode::kInput, Speed::kInput>	;
...
using TIM8_BKIN2_COMP1_PC9 = AnyAltOut<Port::PC, 9, AfTIM8_BKIN2_COMP1_PC9>	;
/// A default configuration to map TIM8 BKIN2_COMP2 on PB6 pin
using TIM8_BKIN2_COMP2_PB6 = AnyAltOut<Port::PB, 6, AfTIM8_BKIN2_COMP2_PB6>	;
/// A default configuration to map TIM8 BKIN_COMP1 on PB7 pin
using TIM8_BKIN_COMP1_PB7 = AnyAltOut<Port::PB, 7, AfTIM8_BKIN_COMP1_PB7>	;
/// A default configuration to map TIM8 BKIN_COMP2 on PA6 pin
using TIM8_BKIN_COMP2_PA6 = AnyAltOut<Port::PA, 6, AfTIM8_BKIN_COMP2_PA6>	;
...
/// A generic configuration to map TIM8 CH1N on PA5 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM8_CH1N_PA5 : AnyAltOut<Port::PA, 5, AfTIM8_CH1N_PA5, kSpeed, kLevel, kPuPd, kMode> {};
/// A default configuration to map TIM8 CH1N on PA5 pin (output)
using TIM8_CH1N_PA5_OUT = TIM8_CH1N_PA5<Mode::kAlternate, Speed::kMedium>	;
...
/// A generic configuration to map TIM8 CH2N on PB14 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM8_CH2N_PB14 : AnyAltOut<Port::PB, 14, AfTIM8_CH2N_PB14, kSpeed, kLevel, kPuPd, kMode> {};
/// A default configuration to map TIM8 CH2N on PB14 pin (output)
using TIM8_CH2N_PB14_OUT = TIM8_CH2N_PB14<Mode::kAlternate, Speed::kMedium>	;
...
/// A generic configuration to map TIM8 CH3N on PB15 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM8_CH3N_PB15 : AnyAltOut<Port::PB, 15, AfTIM8_CH3N_PB15, kSpeed, kLevel, kPuPd, kMode> {};
/// A default configuration to map TIM8 CH3N on PB15 pin (output)
using TIM8_CH3N_PB15_OUT = TIM8_CH3N_PB15<Mode::kAlternate, Speed::kMedium>	;
...
#if defined(GPIOH_BASE)
/// A generic configuration to map TIM8 CH1N on PH13 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM8_CH1N_PH13 : AnyAltOut<Port::PH, 13, AfTIM8_CH1N_PH13, kSpeed, kLevel, kPuPd, kMode> {};
/// A default configuration to map TIM8 CH1N on PH13 pin (output)
using TIM8_CH1N_PH13_OUT = TIM8_CH1N_PH13<Mode::kAlternate, Speed::kMedium>	;

/// A generic configuration to map TIM8 CH2N on PH14 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM8_CH2N_PH14 : AnyAltOut<Port::PH, 14, AfTIM8_CH2N_PH14, kSpeed, kLevel, kPuPd, kMode> {};
/// A default configuration to map TIM8 CH2N on PH14 pin (output)
using TIM8_CH2N_PH14_OUT = TIM8_CH2N_PH14<Mode::kAlternate, Speed::kMedium>	;

/// A generic configuration to map TIM8 CH3N on PH15 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM8_CH3N_PH15 : AnyAltOut<Port::PH, 15, AfTIM8_CH3N_PH15, kSpeed, kLevel, kPuPd, kMode> {};
/// A default configuration to map TIM8 CH3N on PH15 pin (output)
using TIM8_CH3N_PH15_OUT = TIM8_CH3N_PH15<Mode::kAlternate, Speed::kMedium>	;

#endif	// defined(GPIOH_BASE)
#if defined(GPIOI_BASE)
/// A default configuration to map TIM8 BKIN on PI4 pin
using TIM8_BKIN_PI4 = AnyAltOut<Port::PI, 4, AfTIM8_BKIN_PI4>	;
/// A generic configuration to map TIM8 CH1 on PI5 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM8_CH1_PI5 : AnyPin<Port::PI, 5, kMode, kSpeed, kPuPd, kLevel, AfTIM8_CH1_PI5> {};
/// A default configuration to map TIM8 CH1 on PI5 pin (output)
using TIM8_CH1_PI5_OUT = TIM8_CH1_PI5<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM8 CH1 on PI5 pin (input)
using TIM8_CH1_PI5_IN = TIM8_CH1_PI5<Mode::kInput, Speed::kInput>	;

/// A generic configuration to map TIM8 CH2 on PI6 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM8_CH2_PI6 : AnyPin<Port::PI, 6, kMode, kSpeed, kPuPd, kLevel, AfTIM8_CH2_PI6> {};
/// A default configuration to map TIM8 CH2 on PI6 pin (output)
using TIM8_CH2_PI6_OUT = TIM8_CH2_PI6<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM8 CH2 on PI6 pin (input)
using TIM8_CH2_PI6_IN = TIM8_CH2_PI6<Mode::kInput, Speed::kInput>	;

/// A generic configuration to map TIM8 CH3 on PI7 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM8_CH3_PI7 : AnyPin<Port::PI, 7, kMode, kSpeed, kPuPd, kLevel, AfTIM8_CH3_PI7> {};
/// A default configuration to map TIM8 CH3 on PI7 pin (output)
using TIM8_CH3_PI7_OUT = TIM8_CH3_PI7<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM8 CH3 on PI7 pin (input)
using TIM8_CH3_PI7_IN = TIM8_CH3_PI7<Mode::kInput, Speed::kInput>	;

/// A generic configuration to map TIM8 CH4 on PI2 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM8_CH4_PI2 : AnyPin<Port::PI, 2, kMode, kSpeed, kPuPd, kLevel, AfTIM8_CH4_PI2> {};
/// A default configuration to map TIM8 CH4 on PI2 pin (output)
using TIM8_CH4_PI2_OUT = TIM8_CH4_PI2<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM8 CH4 on PI2 pin (input)
using TIM8_CH4_PI2_IN = TIM8_CH4_PI2<Mode::kInput, Speed::kInput>	;

/// A default configuration to map TIM8 ETR on PI3 pin
using TIM8_ETR_PI3 = AnyAltOut<Port::PI, 3, AfTIM8_ETR_PI3>	;
#endif	// defined(GPIOI_BASE)
...
using TIM15_BKIN_PB12 = AnyAltOut<Port::PB, 12, AfTIM15_BKIN_PB12>	;
...
/// A generic configuration to map TIM15 CH1N on PB13 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM15_CH1N_PB13 : AnyAltOut<Port::PB, 13, AfTIM15_CH1N_PB13, kSpeed, kLevel, kPuPd, kMode> {};
/// A default configuration to map TIM15 CH1N on PB13 pin (output)
using TIM15_CH1N_PB13_OUT = TIM15_CH1N_PB13<Mode::kAlternate, Speed::kMedium>	;
...
#endif	// defined(GPIOF_BASE)
#if defined(GPIOG_BASE)
/// A generic configuration to map TIM15 CH1 on PG10 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM15_CH1_PG10 : AnyPin<Port::PG, 10, kMode, kSpeed, kPuPd, kLevel, AfTIM15_CH1_PG10> {};
/// A default configuration to map TIM15 CH1 on PG10 pin (output)
using TIM15_CH1_PG10_OUT = TIM15_CH1_PG10<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM15 CH1 on PG10 pin (input)
using TIM15_CH1_PG10_IN = TIM15_CH1_PG10<Mode::kInput, Speed::kInput>	;
...
/// A generic configuration to map TIM15 CH2 on PG11 pin
template<const Mode kMode, const Speed kSpeed, const PuPd kPuPd = PuPd::kFloating, const Level kLevel = Level::kLow>
struct TIM15_CH2_PG11 : AnyPin<Port::PG, 11, kMode, kSpeed, kPuPd, kLevel, AfTIM15_CH2_PG11> {};
/// A default configuration to map TIM15 CH2 on PG11 pin (output)
using TIM15_CH2_PG11_OUT = TIM15_CH2_PG11<Mode::kAlternate, Speed::kMedium>	;
/// A default configuration to map TIM15 CH2 on PG11 pin (input)
using TIM15_CH2_PG11_IN = TIM15_CH2_PG11<Mode::kInput, Speed::kInput>	;
...
using TSC_G1_IO1_PB12 = AnyAltOut<Port::PB, 12, AfTSC_G1_IO1_PB12>	;
/// A default configuration to map TSC G1_IO2 on PB13 pin
using TSC_G1_IO2_PB13 = AnyAltOut<Port::PB, 13, AfTSC_G1_IO2_PB13>	;
/// A default configuration to map TSC G1_IO3 on PB14 pin
using TSC_G1_IO3_PB14 = AnyAltOut<Port::PB, 14, AfTSC_G1_IO3_PB14>	;
/// A default configuration to map TSC G1_IO4 on PB15 pin
using TSC_G1_IO4_PB15 = AnyAltOut<Port::PB, 15, AfTSC_G1_IO4_PB15>	;
/// A default configuration to map TSC G2_IO1 on PB4 pin
using TSC_G2_IO1_PB4 = AnyAltOut<Port::PB, 4, AfTSC_G2_IO1_PB4>	;
/// A default configuration to map TSC G2_IO2 on PB5 pin
using TSC_G2_IO2_PB5 = AnyAltOut<Port::PB, 5, AfTSC_G2_IO2_PB5>	;
/// A default configuration to map TSC G2_IO3 on PB6 pin
using TSC_G2_IO3_PB6 = AnyAltOut<Port::PB, 6, AfTSC_G2_IO3_PB6>	;
/// A default configuration to map TSC G2_IO4 on PB7 pin
using TSC_G2_IO4_PB7 = AnyAltOut<Port::PB, 7, AfTSC_G2_IO4_PB7>	;
/// A default configuration to map TSC G3_IO1 on PA15 pin
using TSC_G3_IO1_PA15 = AnyAltOut<Port::PA, 15, AfTSC_G3_IO1_PA15>	;
/// A default configuration to map TSC G3_IO2 on PC10 pin
using TSC_G3_IO2_PC10 = AnyAltOut<Port::PC, 10, AfTSC_G3_IO2_PC10>	;
/// A default configuration to map TSC G3_IO3 on PC11 pin
using TSC_G3_IO3_PC11 = AnyAltOut<Port::PC, 11, AfTSC_G3_IO3_PC11>	;
/// A default configuration to map TSC G3_IO4 on PC12 pin
using TSC_G3_IO4_PC12 = AnyAltOut<Port::PC, 12, AfTSC_G3_IO4_PC12>	;
/// A default configuration to map TSC G4_IO1 on PC6 pin
using TSC_G4_IO1_PC6 = AnyAltOut<Port::PC, 6, AfTSC_G4_IO1_PC6>	;
/// A default configuration to map TSC G4_IO2 on PC7 pin
using TSC_G4_IO2_PC7 = AnyAltOut<Port::PC, 7, AfTSC_G4_IO2_PC7>	;
/// A default configuration to map TSC G4_IO3 on PC8 pin
using TSC_G4_IO3_PC8 = AnyAltOut<Port::PC, 8, AfTSC_G4_IO3_PC8>	;
/// A default configuration to map TSC G4_IO4 on PC9 pin
using TSC_G4_IO4_PC9 = AnyAltOut<Port::PC, 9, AfTSC_G4_IO4_PC9>	;
/// A default configuration to map TSC SYNC on PB10 pin
using TSC_SYNC_PB10 = AnyAltOut<Port::PB, 10, AfTSC_SYNC_PB10>	;
#if defined(GPIOD_BASE)
/// A default configuration to map TSC G6_IO1 on PD10 pin
using TSC_G6_IO1_PD10 = AnyAltOut<Port::PD, 10, AfTSC_G6_IO1_PD10>	;
/// A default configuration to map TSC G6_IO2 on PD11 pin
using TSC_G6_IO2_PD11 = AnyAltOut<Port::PD, 11, AfTSC_G6_IO2_PD11>	;
/// A default configuration to map TSC G6_IO3 on PD12 pin
using TSC_G6_IO3_PD12 = AnyAltOut<Port::PD, 12, AfTSC_G6_IO3_PD12>	;
/// A default configuration to map TSC G6_IO4 on PD13 pin
using TSC_G6_IO4_PD13 = AnyAltOut<Port::PD, 13, AfTSC_G6_IO4_PD13>	;
/// A default configuration to map TSC SYNC on PD2 pin
using TSC_SYNC_PD2 = AnyAltOut<Port::PD, 2, AfTSC_SYNC_PD2>	;
#endif	// defined(GPIOD_BASE)
#if defined(GPIOE_BASE)
/// A default configuration to map TSC G5_IO1 on PE10 pin
using TSC_G5_IO1_PE10 = AnyAltOut<Port::PE, 10, AfTSC_G5_IO1_PE10>	;
/// A default configuration to map TSC G5_IO2 on PE11 pin
using TSC_G5_IO2_PE11 = AnyAltOut<Port::PE, 11, AfTSC_G5_IO2_PE11>	;
/// A default configuration to map TSC G5_IO3 on PE12 pin
using TSC_G5_IO3_PE12 = AnyAltOut<Port::PE, 12, AfTSC_G5_IO3_PE12>	;
/// A default configuration to map TSC G5_IO4 on PE13 pin
using TSC_G5_IO4_PE13 = AnyAltOut<Port::PE, 13, AfTSC_G5_IO4_PE13>	;
/// A default configuration to map TSC G7_IO1 on PE2 pin
using TSC_G7_IO1_PE2 = AnyAltOut<Port::PE, 2, AfTSC_G7_IO1_PE2>	;
/// A default configuration to map TSC G7_IO2 on PE3 pin
using TSC_G7_IO2_PE3 = AnyAltOut<Port::PE, 3, AfTSC_G7_IO2_PE3>	;
/// A default configuration to map TSC G7_IO3 on PE4 pin
using TSC_G7_IO3_PE4 = AnyAltOut<Port::PE, 4, AfTSC_G7_IO3_PE4>	;
/// A default configuration to map TSC G7_IO4 on PE5 pin
using TSC_G7_IO4_PE5 = AnyAltOut<Port::PE, 5, AfTSC_G7_IO4_PE5>	;
#endif	// defined(GPIOE_BASE)
#if defined(GPIOF_BASE)
/// A default configuration to map TSC G8_IO1 on PF14 pin
using TSC_G8_IO1_PF14 = AnyAltOut<Port::PF, 14, AfTSC_G8_IO1_PF14>	;
/// A default configuration to map TSC G8_IO2 on PF15 pin
using TSC_G8_IO2_PF15 = AnyAltOut<Port::PF, 15, AfTSC_G8_IO2_PF15>	;
#endif	// defined(GPIOF_BASE)
#if defined(GPIOG_BASE)
/// A default configuration to map TSC G8_IO3 on PG0 pin
using TSC_G8_IO3_PG0 = AnyAltOut<Port::PG, 0, AfTSC_G8_IO3_PG0>	;
/// A default configuration to map TSC G8_IO4 on PG1 pin
using TSC_G8_IO4_PG1 = AnyAltOut<Port::PG, 1, AfTSC_G8_IO4_PG1>	;
#endif	// defined(GPIOG_BASE)
...
using USART1_CK_PB5 = AnyAltOut<Port::PB, 5, AfUSART1_CK_PB5>	;
...
using AfUSART1_CTS_PB4 = AnyAltOutOD<Port::PB, 4, AfUSART1_CTS_PB4>	;
/// A default configuration to map USART1 DE on PA12 pin
using USART1_DE_PA12 = AnyAltOut<Port::PA, 12, AfUSART1_DE_PA12>	;
/// A default configuration to map USART1 DE on PB3 pin
using USART1_DE_PB3 = AnyAltOut<Port::PB, 3, AfUSART1_DE_PB3>	;
/// A default configuration to map USART1 RTS on PA12 pin
using USART1_RTS_PA12 = AnyAltOut<Port::PA, 12, AfUSART1_RTS_PA12>	;
/// A default configuration to map USART1 RTS on PB3 pin
using USART1_RTS_PB3 = AnyAltOut<Port::PB, 3, AfUSART1_RTS_PB3>	;
...
using USART1_CK_PG13 = AnyAltOut<Port::PG, 13, AfUSART1_CK_PG13>	;
/// A default configuration to map USART1 CTS on PG11 pin
using AfUSART1_CTS_PG11 = AnyAltOutOD<Port::PG, 11, AfUSART1_CTS_PG11>	;
/// A default configuration to map USART1 DE on PG12 pin
using USART1_DE_PG12 = AnyAltOut<Port::PG, 12, AfUSART1_DE_PG12>	;
/// A default configuration to map USART1 RTS on PG12 pin
using USART1_RTS_PG12 = AnyAltOut<Port::PG, 12, AfUSART1_RTS_PG12>	;
/// A default configuration to map USART1 RX on PG10 pin
using AfUSART1_RX_PG10 = AnyAltOutOD<Port::PG, 10, AfUSART1_RX_PG10>	;
...
using USART2_DE_PA1 = AnyAltOut<Port::PA, 1, AfUSART2_DE_PA1>	;
/// A default configuration to map USART2 RTS on PA1 pin
using USART2_RTS_PA1 = AnyAltOut<Port::PA, 1, AfUSART2_RTS_PA1>	;
...
using USART2_DE_PD4 = AnyAltOut<Port::PD, 4, AfUSART2_DE_PD4>	;
/// A default configuration to map USART2 RTS on PD4 pin
using USART2_RTS_PD4 = AnyAltOut<Port::PD, 4, AfUSART2_RTS_PD4>	;
...
using USART3_CK_PB0 = AnyAltOut<Port::PB, 0, AfUSART3_CK_PB0>	;
...
using AfUSART3_CTS_PA6 = AnyAltOutOD<Port::PA, 6, AfUSART3_CTS_PA6>	;
...
using USART3_DE_PA15 = AnyAltOut<Port::PA, 15, AfUSART3_DE_PA15>	;
/// A default configuration to map USART3 DE on PB1 pin
using USART3_DE_PB1 = AnyAltOut<Port::PB, 1, AfUSART3_DE_PB1>	;
/// A default configuration to map USART3 DE on PB14 pin
using USART3_DE_PB14 = AnyAltOut<Port::PB, 14, AfUSART3_DE_PB14>	;
/// A default configuration to map USART3 RTS on PA15 pin
using USART3_RTS_PA15 = AnyAltOut<Port::PA, 15, AfUSART3_RTS_PA15>	;
/// A default configuration to map USART3 RTS on PB1 pin
using USART3_RTS_PB1 = AnyAltOut<Port::PB, 1, AfUSART3_RTS_PB1>	;
/// A default configuration to map USART3 RTS on PB14 pin
using USART3_RTS_PB14 = AnyAltOut<Port::PB, 14, AfUSART3_RTS_PB14>	;
...
using AfUSART3_RX_PC5 = AnyAltOutOD<Port::PC, 5, AfUSART3_RX_PC5>	;
...
using USART3_TX_PC4 = AnyAltOut<Port::PC, 4, AfUSART3_TX_PC4>	;
...
using USART3_DE_PD2 = AnyAltOut<Port::PD, 2, AfUSART3_DE_PD2>	;
/// A default configuration to map USART3 DE on PD12 pin
using USART3_DE_PD12 = AnyAltOut<Port::PD, 12, AfUSART3_DE_PD12>	;
/// A default configuration to map USART3 RTS on PD2 pin
using USART3_RTS_PD2 = AnyAltOut<Port::PD, 2, AfUSART3_RTS_PD2>	;
/// A default configuration to map USART3 RTS on PD12 pin
using USART3_RTS_PD12 = AnyAltOut<Port::PD, 12, AfUSART3_RTS_PD12>	;
...
using UART4_DE_PA15 = AnyAltOut<Port::PA, 15, AfUART4_DE_PA15>	;
/// A default configuration to map UART4 RTS on PA15 pin
using UART4_RTS_PA15 = AnyAltOut<Port::PA, 15, AfUART4_RTS_PA15>	;
/// A default configuration to map UART4 RX on PA1 pin
using AfUART4_RX_PA1 = AnyAltOutOD<Port::PA, 1, AfUART4_RX_PA1>	;
...
using UART4_TX_PA0 = AnyAltOut<Port::PA, 0, AfUART4_TX_PA0>	;
...
using UART5_DE_PB4 = AnyAltOut<Port::PB, 4, AfUART5_DE_PB4>	;
/// A default configuration to map UART5 RTS on PB4 pin
using UART5_RTS_PB4 = AnyAltOut<Port::PB, 4, AfUART5_RTS_PB4>	;
...
using EVENTOUT_PG11 = AnyAltOut<Port::PG, 11, AfEVENTOUT_PG11>	;
/// A default configuration to map EVENTOUT on PG12 pin
using EVENTOUT_PG12 = AnyAltOut<Port::PG, 12, AfEVENTOUT_PG12>	;
/// A default configuration to map EVENTOUT on PG13 pin
using EVENTOUT_PG13 = AnyAltOut<Port::PG, 13, AfEVENTOUT_PG13>	;
/// A default configuration to map EVENTOUT on PG14 pin
using EVENTOUT_PG14 = AnyAltOut<Port::PG, 14, AfEVENTOUT_PG14>	;
/// A default configuration to map EVENTOUT on PG15 pin
using EVENTOUT_PG15 = AnyAltOut<Port::PG, 15, AfEVENTOUT_PG15>	;
#endif	// defined(GPIOG_BASE)
#if defined(GPIOH_BASE)
/// A default configuration to map EVENTOUT on PH0 pin
using EVENTOUT_PH0 = AnyAltOut<Port::PH, 0, AfEVENTOUT_PH0>	;
/// A default configuration to map EVENTOUT on PH1 pin
using EVENTOUT_PH1 = AnyAltOut<Port::PH, 1, AfEVENTOUT_PH1>	;
/// A default configuration to map EVENTOUT on PH2 pin
using EVENTOUT_PH2 = AnyAltOut<Port::PH, 2, AfEVENTOUT_PH2>	;
/// A default configuration to map EVENTOUT on PH3 pin
using EVENTOUT_PH3 = AnyAltOut<Port::PH, 3, AfEVENTOUT_PH3>	;
/// A default configuration to map EVENTOUT on PH4 pin
using EVENTOUT_PH4 = AnyAltOut<Port::PH, 4, AfEVENTOUT_PH4>	;
/// A default configuration to map EVENTOUT on PH5 pin
using EVENTOUT_PH5 = AnyAltOut<Port::PH, 5, AfEVENTOUT_PH5>	;
/// A default configuration to map EVENTOUT on PH6 pin
using EVENTOUT_PH6 = AnyAltOut<Port::PH, 6, AfEVENTOUT_PH6>	;
/// A default configuration to map EVENTOUT on PH7 pin
using EVENTOUT_PH7 = AnyAltOut<Port::PH, 7, AfEVENTOUT_PH7>	;
/// A default configuration to map EVENTOUT on PH8 pin
using EVENTOUT_PH8 = AnyAltOut<Port::PH, 8, AfEVENTOUT_PH8>	;
/// A default configuration to map EVENTOUT on PH9 pin
using EVENTOUT_PH9 = AnyAltOut<Port::PH, 9, AfEVENTOUT_PH9>	;
/// A default configuration to map EVENTOUT on PH10 pin
using EVENTOUT_PH10 = AnyAltOut<Port::PH, 10, AfEVENTOUT_PH10>	;
/// A default configuration to map EVENTOUT on PH11 pin
using EVENTOUT_PH11 = AnyAltOut<Port::PH, 11, AfEVENTOUT_PH11>	;
/// A default configuration to map EVENTOUT on PH12 pin
using EVENTOUT_PH12 = AnyAltOut<Port::PH, 12, AfEVENTOUT_PH12>	;
/// A default configuration to map EVENTOUT on PH13 pin
using EVENTOUT_PH13 = AnyAltOut<Port::PH, 13, AfEVENTOUT_PH13>	;
/// A default configuration to map EVENTOUT on PH14 pin
using EVENTOUT_PH14 = AnyAltOut<Port::PH, 14, AfEVENTOUT_PH14>	;
/// A default configuration to map EVENTOUT on PH15 pin
using EVENTOUT_PH15 = AnyAltOut<Port::PH, 15, AfEVENTOUT_PH15>	;
#endif	// defined(GPIOH_BASE)
#if defined(GPIOI_BASE)
/// A default configuration to map EVENTOUT on PI0 pin
using EVENTOUT_PI0 = AnyAltOut<Port::PI, 0, AfEVENTOUT_PI0>	;
/// A default configuration to map EVENTOUT on PI1 pin
using EVENTOUT_PI1 = AnyAltOut<Port::PI, 1, AfEVENTOUT_PI1>	;
/// A default configuration to map EVENTOUT on PI2 pin
using EVENTOUT_PI2 = AnyAltOut<Port::PI, 2, AfEVENTOUT_PI2>	;
/// A default configuration to map EVENTOUT on PI3 pin
using EVENTOUT_PI3 = AnyAltOut<Port::PI, 3, AfEVENTOUT_PI3>	;
/// A default configuration to map EVENTOUT on PI4 pin
using EVENTOUT_PI4 = AnyAltOut<Port::PI, 4, AfEVENTOUT_PI4>	;
/// A default configuration to map EVENTOUT on PI5 pin
using EVENTOUT_PI5 = AnyAltOut<Port::PI, 5, AfEVENTOUT_PI5>	;
/// A default configuration to map EVENTOUT on PI6 pin
using EVENTOUT_PI6 = AnyAltOut<Port::PI, 6, AfEVENTOUT_PI6>	;
/// A default configuration to map EVENTOUT on PI7 pin
using EVENTOUT_PI7 = AnyAltOut<Port::PI, 7, AfEVENTOUT_PI7>	;
/// A default configuration to map EVENTOUT on PI8 pin
using EVENTOUT_PI8 = AnyAltOut<Port::PI, 8, AfEVENTOUT_PI8>	;
/// A default configuration to map EVENTOUT on PI9 pin
using EVENTOUT_PI9 = AnyAltOut<Port::PI, 9, AfEVENTOUT_PI9>	;
/// A default configuration to map EVENTOUT on PI10 pin
using EVENTOUT_PI10 = AnyAltOut<Port::PI, 10, AfEVENTOUT_PI10>	;
/// A default configuration to map EVENTOUT on PI11 pin
using EVENTOUT_PI11 = AnyAltOut<Port::PI, 11, AfEVENTOUT_PI11>	;
#endif	// defined(GPIOI_BASE)
