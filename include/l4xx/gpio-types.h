...
using COMP1_INM_PB1 = AnyAnalog<Port::PB, 1>;
/// A default configuration to map COMP1 INM on PC4 pin
using COMP1_INM_PC4 = AnyAnalog<Port::PC, 4>;
/// A default configuration to map COMP1 INP on PB2 pin
using COMP1_INP_PB2 = AnyAnalog<Port::PB, 2>;
/// A default configuration to map COMP1 INP on PC5 pin
using COMP1_INP_PC5 = AnyAnalog<Port::PC, 5>;
...
using COMP2_INM_PB3 = AnyAnalog<Port::PB, 3>;
/// A default configuration to map COMP2 INM on PB7 pin
using COMP2_INM_PB7 = AnyAnalog<Port::PB, 7>;
/// A default configuration to map COMP2 INP on PB4 pin
using COMP2_INP_PB4 = AnyAnalog<Port::PB, 4>;
/// A default configuration to map COMP2 INP on PB6 pin
using COMP2_INP_PB6 = AnyAnalog<Port::PB, 6>;
...
using TIM3_CH1_PE3 = AnyAltOut<Port::PE, 3, AfTIM3_CH1_PE3>;
/// A default configuration to map TIM3 CH2 on PE4 pin
using TIM3_CH2_PE4 = AnyAltOut<Port::PE, 4, AfTIM3_CH2_PE4>;
/// A default configuration to map TIM3 CH3 on PE5 pin
using TIM3_CH3_PE5 = AnyAltOut<Port::PE, 5, AfTIM3_CH3_PE5>;
/// A default configuration to map TIM3 CH4 on PE6 pin
using TIM3_CH4_PE6 = AnyAltOut<Port::PE, 6, AfTIM3_CH4_PE6>;
...
using TIM5_CH1_PH10 = AnyAltOut<Port::PH, 10, AfTIM5_CH1_PH10>;
/// A default configuration to map TIM5 CH2 on PH11 pin
using TIM5_CH2_PH11 = AnyAltOut<Port::PH, 11, AfTIM5_CH2_PH11>;
/// A default configuration to map TIM5 CH3 on PH12 pin
using TIM5_CH3_PH12 = AnyAltOut<Port::PH, 12, AfTIM5_CH3_PH12>;
#endif	// defined(GPIOH_BASE)
#if defined(GPIOI_BASE)
/// A default configuration to map TIM5 CH4 on PI0 pin
using TIM5_CH4_PI0 = AnyAltOut<Port::PI, 0, AfTIM5_CH4_PI0>;
#endif	// defined(GPIOI_BASE)
...
using TIM8_CH1N_PA5 = AnyAltOut<Port::PA, 5, AfTIM8_CH1N_PA5>;
...
using TIM8_CH2N_PB14 = AnyAltOut<Port::PB, 14, AfTIM8_CH2N_PB14>;
...
using TIM8_CH3N_PB15 = AnyAltOut<Port::PB, 15, AfTIM8_CH3N_PB15>;
...
using TIM8_CH1N_PH13 = AnyAltOut<Port::PH, 13, AfTIM8_CH1N_PH13>;
/// A default configuration to map TIM8 CH2N on PH14 pin
using TIM8_CH2N_PH14 = AnyAltOut<Port::PH, 14, AfTIM8_CH2N_PH14>;
/// A default configuration to map TIM8 CH3N on PH15 pin
using TIM8_CH3N_PH15 = AnyAltOut<Port::PH, 15, AfTIM8_CH3N_PH15>;
#endif	// defined(GPIOH_BASE)
#if defined(GPIOI_BASE)
...
using TIM8_CH1_PI5 = AnyAltOut<Port::PI, 5, AfTIM8_CH1_PI5>;
/// A default configuration to map TIM8 CH2 on PI6 pin
using TIM8_CH2_PI6 = AnyAltOut<Port::PI, 6, AfTIM8_CH2_PI6>;
/// A default configuration to map TIM8 CH3 on PI7 pin
using TIM8_CH3_PI7 = AnyAltOut<Port::PI, 7, AfTIM8_CH3_PI7>;
/// A default configuration to map TIM8 CH4 on PI2 pin
using TIM8_CH4_PI2 = AnyAltOut<Port::PI, 2, AfTIM8_CH4_PI2>;
...
using TIM15_CH1N_PB13 = AnyAltOut<Port::PB, 13, AfTIM15_CH1N_PB13>;
...
using TIM15_CH1_PG10 = AnyAltOut<Port::PG, 10, AfTIM15_CH1_PG10>;
...
using TIM15_CH2_PG11 = AnyAltOut<Port::PG, 11, AfTIM15_CH2_PG11>;
#endif	// defined(GPIOG_BASE)
